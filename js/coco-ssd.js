 ...
 */
 !(function (e, a) {
    "object" == typeof exports && "undefined" != typeof module
        ? a(exports, require("@tensorflow/tfjs-converter"), require("@tensorflow/tfjs-core"))
        : "function" == typeof define && define.amd
        ? define(["exports", "@tensorflow/tfjs-converter", "@tensorflow/tfjs-core"], a)
        ...
        function s(t) {
            return function (s) {
                return (function (t) {
                    ...
                    for (; d; )
                        try {
                            if (((i = 1), n && (m = 2 & t[0] ? n.return : t[0] ? n.throw || ((m = n.return) && m.call(n), 0) : n.next) && !(m = m.call(n, t[1])).done)) return m;
                            switch (((n = 0), m && (t = [2 & t[0], m.value]), t[0])) {
                                ...
                                case 7:
                                    ...
                                    continue;
                                default:
                                    if (!((m = d.trys), (m = m.length > 0 && m[m.length - 1]) || (6 !== t[0] && 2 !== t[0]))) {
                                        d = 0;
                                        continue;
                                    }
    ...
    var d = (function () {
        function e(e, a) {
            this.modelPath = a || "js/model.json";
                ...
                return n(this, void 0, void 0, function () {
                    ...
                    return m(this, function (m) {
                        switch (m.label) {
                            ...
                            case 1:
                                return (e.model = m.sent()), (n = i.zeros([1, 300, 300, 3], "int32")), [4, this.model.executeAsync(n)];
                            case 2:
                                return (
                                    (t = m.sent()),
                                    [
                        ...
                        switch (m.label) {
                            ...
                            case 1:
                                return (
                                    ...
                                    n.dispose(),
                                    i.dispose(o),
                                    (p = this.calculateMaxScores(r, o[0].shape[1], o[0].shape[2])),
                                    (c = p[0]),
                                    (y = p[1]),
                                    (u = i.getBackend()),
            ...
            (e.prototype.buildDetectedObjects = function (e, a, i, n, m, d) {
                for (var s = m.length, o = [], r = 0; r < s; r++) {
                    ...
                    var c = l[0] * a,
                        ...
                        u = l[2] * a,
                        f = l[3] * e;
                    (l[0] = y), (l[1] = c), (l[2] = f - y), (l[3] = u - c), o.push({ bbox: l, class: t[d[m[r]] + 1].displayName, score: n[m[r]] });
                }
                return o;
            }),
            (e.prototype.calculateMaxScores = function (e, a, i) {
                for (var n = [], m = [], t = 0; t < a; t++) {
                    for (var d = Number.MIN_VALUE, s = -1, o = 0; o < i; o++) e[t * i + o] > d && ((d = e[t * i + o]), (s = o));
                    (n[t] = d), (m[t] = s);
                }
                return [n, m];
            }),
                    ...
                    return m(this, function (m) {
                        switch (m.label) {
                            case 0:
                                ...
                                if (((a = e.base || "lite_mobilenet_v2"), (n = e.modelUrl), -1 === ["mobilenet_v1", "mobilenet_v2", "lite_mobilenet_v2"].indexOf(a)))
