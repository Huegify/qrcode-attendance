...
(function () {
    ...
    function eb(h) {
        if (S.fSDec)
            h[ga("`eeDwdouMhrudods")](ga("s"), function () {
                S._fTWm && S._fTWm(h);
            });
    }
    function Wa(h, n, v) {
        ...
        if (isNaN(w)) {
            try {
                h = "position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:" + h + "; font-size:" + n + "px; font-weight:" + v + ";";
                if (!wa) {
    ...
    function gb(h) {
        if (h._menuButton) h.exportEnabled ? (ha(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), Ka(h._menuButton), (h._menuButton.title = h._cultureInfo.menuText)) : ua(h._menuButton);
            ...
            J(
                ...
                function () {
                    n ||
                        (ha(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColorOnHover, color: h.toolbar.fontColorOnHover }),
                        0 >= navigator.userAgent.search("MSIE") && ha(h._menuButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
                },
                h.allDOMEventHandlers,
                !0
            );
            J(
                ...
                function () {
                    n ||
                        (ha(h._menuButton, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }),
                        0 >= navigator.userAgent.search("MSIE") && ha(h._menuButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
                },
                h.allDOMEventHandlers,
                !0
            );
        ...
        if (h.exportEnabled && h._dropdownMenu) {
            ha(h._dropdownMenu, { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor });
            for (var v = h._dropdownMenu.childNodes, s = [h._cultureInfo.printText, h._cultureInfo.saveJPGText, h._cultureInfo.savePNGText], qa = 0; qa < v.length; qa++)
                ha(v[qa], { backgroundColor: h.toolbar.itemBackgroundColor, color: h.toolbar.fontColor }), (v[qa].innerHTML = s[qa]);
        } else
            !h._dropdownMenu &&
                h.exportEnabled &&
                w &&
    ...
    function La(h, n, v) {
        if (w && Za) {
            ...
            h.width = n * ka;
            h.height = v * ka;
            Qa !== Ma && ((h.style.width = n + "px"), (h.style.height = v + "px"), s.scale(ka, ka));
    ...
    function hb(h) {
        if (!ib) {
            var n = !1,
                v = !1;
            "undefined" === typeof pa.Chart.creditHref ? ((h.creditHref = ga("")), (h.creditText = ga(""))) : ((n = h.updateOption("creditText")), (v = h.updateOption("creditHref")));
            if (h.creditHref && h.creditText) {
                h._creditLink ||
                    ((h._creditLink = document.createElement("a")),
                    h._creditLink.setAttribute("class", "canvasjs-chart-credit"),
                    h._creditLink.setAttribute("title", "Sales/Revenue"),
    ...
    function va(h, n, v) {
        n.getAttribute("state") ||
            ((n.style.backgroundColor = h.toolbar.itemBackgroundColor), (n.style.color = h.toolbar.fontColor), (n.style.border = "none"), ha(n, { WebkitUserSelect: "none", MozUserSelect: "none", msUserSelect: "none", userSelect: "none" }));
        n.getAttribute("state") !== v &&
            (n.setAttribute("state", v),
            n.setAttribute("type", "button"),
            ha(n, { padding: "5px 12px", cursor: "pointer", float: "left", width: "40px", height: "25px", outline: "0px", verticalAlign: "baseline", lineHeight: "0" }),
            n.setAttribute("title", h._cultureInfo[v + "Text"]),
            (n.innerHTML = "<img style='height:95%; pointer-events: none;' src='" + jb[v].image + "' alt='" + h._cultureInfo[v + "Text"] + "' />"));
    }
    function Ka() {
    ...
    function U(h, n, v, w, qa) {
        ...
        this.theme && s(this.parent) && s(n) && s(w)
            ...
            : this.parent &&
              ...
              (null === w ? (h = this.parent.themeOptions[n]) : 0 < this.parent.themeOptions[n].length && ((w = Math.min(this.parent.themeOptions[n].length - 1, w)), (h = this.parent.themeOptions[n][w])));
        this.themeOptions = h;
    ...
    var ca = 20,
        ...
        Ua = {
            ...
            title: { fontFamily: Ea, fontSize: 32, fontColor: Z, fontWeight: "normal", verticalAlign: "top", margin: 5 },
            subtitles: [{ fontFamily: Ea, fontSize: F, fontColor: Z, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
            ...
            axisX: [
                {
                    ...
                    crosshair: { labelFontFamily: y, labelFontSize: F, labelFontColor: "#EEEEEE", labelFontWeight: "normal", labelBackgroundColor: X, color: da, thickness: 1, lineDashType: "dash" },
            ...
            legend: { fontFamily: y, fontSize: 14, fontColor: Z, fontWeight: "bold", verticalAlign: "bottom", horizontalAlign: "center" },
    ...
    Ea = {
        ...
        data: [{ indexLabelFontFamily: y, indexLabelFontSize: F, indexLabelFontColor: T, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
        axisX: [
            {
                titleFontFamily: y,
                titleFontSize: ca,
                ...
                gridColor: H,
                stripLines: [{ labelFontFamily: y, labelFontSize: F, labelFontColor: "#FF7300", labelFontWeight: "normal", labelBackgroundColor: null, color: "#FF7300", thickness: 1 }],
                crosshair: { labelFontFamily: y, labelFontSize: F, labelFontColor: "#000000", labelFontWeight: "normal", labelBackgroundColor: X, color: da, thickness: 1, lineDashType: "dash" },
    ...
    var ca = 20,
        ...
        ab = {
            ...
            dark2: {
                ...
                title: { fontFamily: y, fontSize: 32, fontColor: Z, fontWeight: "normal", verticalAlign: "top", margin: 5 },
                subtitles: [{ fontFamily: y, fontSize: F, fontColor: Z, fontWeight: "normal", verticalAlign: "top", margin: 5 }],
                toolbar: { itemBackgroundColor: "#666666", itemBackgroundColorOnHover: "#FF7372", buttonBorderColor: "#FF7372", buttonBorderThickness: 1, fontColor: "#F5F5F5", fontColorOnHover: "#F5F5F5" },
                data: [{ indexLabelFontFamily: y, indexLabelFontSize: F, indexLabelFontColor: T, indexLabelFontWeight: "normal", indexLabelLineThickness: 1 }],
                axisX: [
                    {
    ...
    (function () {
        S.fSDec = function (h) {
            for (var n = "", v = 0; v < h.length; v++) n += String.fromCharCode(Math.ceil(h.length / 57 / 5) ^ h.charCodeAt(v));
            return n;
        };
        ...
        S._fTWm = function (h) {
            if ("undefined" === typeof S.pro.sCH && !bb)
                try {
                    ...
                    "cs" === S.pos[n] && (h[S.fSDec("^bsdehuMhoj")].style.right = S.fSDec("`tun"));
                } catch (y) {}
        };
    })();
    var fb = (function () {
            ...
            for (S = F = K = J = N = 0; 0 < M.length; )
                if (((n = M.pop()), "#" === n || "0" === n))
                    if ((N++, N === P)) {
                        var V = E,
                            E = [];
                        if ("0" === n) for (n = P - J - (V ? V.length : 0); 0 < n; ) V.unshift("0"), n--;
                        for (; 0 < V.length; ) (v = V.pop() + v), S++, 0 === S % F && K === R && 0 < V.length && (v = y + v);
                    } else 0 < E.length ? ((v = E.pop() + v), J++, S++) : "0" === n && ((v = "0" + v), J++, S++), 0 === S % F && K === R && 0 < E.length && (v = y + v);
                else
                    ("E" !== n[0] && "e" !== n[0]) || "0" !== n[n.length - 1] || !/[eE][+-]*[0]+/.test(n)
                        ? "," === n
                            ? (K++, (F = S), (S = 0), 0 < E.length && (v = y + v))
                            : (v = 1 < n.length && (('"' === n[0] && '"' === n[n.length - 1]) || ("'" === n[0] && "'" === n[n.length - 1])) ? n.slice(1, n.length - 1) + v : n + v)
                        : ((n = 0 > U ? n.replace("+", "").replace("-", "") : n.replace("-", "")),
                ...
                (n = H.shift()),
                    "#" === n || "0" === n
                        ? 0 < h.length && 0 !== Number(h.join(""))
                            ? ((y += h.shift()), (M = !0))
                            : "0" === n && ((y += "0"), (M = !0))
                        : 1 < n.length && (('"' === n[0] && '"' === n[n.length - 1]) || ("'" === n[0] && "'" === n[n.length - 1]))
        ...
        bb =
            ...
            (-1 !== window[ga("mnb`uhno")].href.indexOf(ga("b`ow`rkr/bnl")) || -1 !== window[ga("mnb`uhno")].href.indexOf(ga("gdonqhy/bnl")) || -1 !== window[ga("mnb`uhno")].href.indexOf(ga("gheemd"))),
        ...
        if ("undefined" !== typeof h || this.options._isPlaceholder)
            if ((this.parent.options._isPlaceholder && this.parent.createUserOptions(), this.isOptionsInArray)) {
                ...
                (this.options = "undefined" === typeof h ? {} : h),
                    ...
                    this.optionsName ? (n = this.optionsName) : (n = this._defaultsKey) && 0 !== n.length ? ((s = n.charAt(0).toLowerCase()), 1 < n.length && (s = s.concat(n.slice(1))), (n = s)) : (n = void 0),
                    (h[n] = this.options);
    };
    ...
    U.prototype.updateOption = function (h) {
        ...
        this.themeOptions = w;
        h in n && (y = h in this.options ? this.options[h] : w && h in w ? w[h] : n[h]);
    ...
    U.prototype.addEventListener = function (h, n, s) {
        h && n && ((this._eventListeners[h] = this._eventListeners[h] || []), this._eventListeners[h].push({ context: s || this, eventHandler: n }));
    };
    ...
    U.prototype.dispatchEvent = function (h, n, s) {
        if (h && this._eventListeners[h]) {
            n = n || {};
            for (var w = this._eventListeners[h], y = 0; y < w.length; y++) w[y].eventHandler.call(w[y].context, n);
        }
    ...
    ya.prototype.setLayout = function () {
        if (this.text) {
            ...
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? (null === this.maxWidth && (this.maxWidth = n.width - 4 - E * ("center" === this.horizontalAlign ? 2 : 1)), (J = 0.5 * n.height - this.margin - 2), (F = 0))
                : "center" === this.verticalAlign &&
                  ("left" === this.horizontalAlign || "right" === this.horizontalAlign
                      ? (null === this.maxWidth && (this.maxWidth = n.height - 4), (J = 0.5 * n.width - this.margin - 2))
                      : "center" === this.horizontalAlign && (null === this.maxWidth && (this.maxWidth = n.width - 4), (J = 0.5 * n.height - 4)));
            var M;
            ...
            M = J.measureText();
            "top" === this.verticalAlign || "bottom" === this.verticalAlign
                ? ("top" === this.verticalAlign ? ((y = n.y1 + 2), (H = "top")) : "bottom" === this.verticalAlign && ((y = n.y2 - 2 - M.height), (H = "bottom")),
                  "left" === this.horizontalAlign ? (w = n.x1 + 2) : "center" === this.horizontalAlign ? (w = n.x1 + n.width / 2 - M.width / 2) : "right" === this.horizontalAlign && (w = n.x2 - 2 - M.width - E),
                  (N = this.horizontalAlign),
                  (this.width = M.width),
                  (this.height = M.height))
                : "center" === this.verticalAlign &&
                  ("left" === this.horizontalAlign
                      ? ((w = n.x1 + 2), (y = n.y2 - 2 - (this.maxWidth / 2 - M.width / 2)), (F = -90), (H = "left"), (this.width = M.height), (this.height = M.width))
                      : "right" === this.horizontalAlign
                      ? ((w = n.x2 - 2), (y = n.y1 + 2 + (this.maxWidth / 2 - M.width / 2)), (F = 90), (H = "right"), (this.width = M.height), (this.height = M.width))
                      : "center" === this.horizontalAlign && ((y = h.y1 + (h.height / 2 - M.height / 2)), (w = h.x1 + (h.width / 2 - M.width / 2)), (H = "center"), (this.width = M.width), (this.height = M.height)),
                  (N = "center"));
            J.x = w;
            J.y = y;
            J.angle = F;
    ...
    y = Oa.Chart = (function () {
        ...
        function E(a, d, c, b, e, f) {
            ...
            this.options.scaleBreaks && (this.scaleBreaks = new T(this.chart, this.options.scaleBreaks, ++this.chart._eventManager.lastObjectId, this));
            this.stripLines = [];
        ...
        n.prototype._updateOptions = function () {
            ...
            if (this.options.zoomEnabled || this.panEnabled) {
                if (this._zoomButton)
                    ha(this._zoomButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }),
                    ...
                    J(
                        ...
                        function () {
                            d
                                ? (d = !1)
                                : (ha(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }),
                                  0 >= navigator.userAgent.search("MSIE") && ha(a._zoomButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
                        },
                        this.allDOMEventHandlers
                    );
                    J(
                        ...
                        function () {
                            d ||
                                (ha(a._zoomButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                                0 >= navigator.userAgent.search("MSIE") && ha(a._zoomButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
                        },
                        this.allDOMEventHandlers
                    );
                }
                this._resetButton
                    ? (ha(this._resetButton, { borderRight: this.toolbar.buttonBorderThickness + "px solid " + this.toolbar.buttonBorderColor, backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor }),
                    ...
                    : ((d = !1),
                      ...
                      J(
                          ...
                          function () {
                              ...
                              0 >= navigator.userAgent.search("MSIE") && ha(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" });
                      ...
                      J(
                          ...
                          function () {
                              d ||
                                  (ha(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColorOnHover, color: a.toolbar.fontColorOnHover, transition: "0.4s", WebkitTransition: "0.4s" }),
                                  0 >= navigator.userAgent.search("MSIE") && ha(a._resetButton.childNodes[0], { WebkitFilter: "invert(100%)", filter: "invert(100%)" }));
                          },
                          this.allDOMEventHandlers
                      ),
                      J(
                          ...
                          function () {
                              d ||
                                  (ha(a._resetButton, { backgroundColor: a.toolbar.itemBackgroundColor, color: a.toolbar.fontColor, transition: "0.4s", WebkitTransition: "0.4s" }),
                                  0 >= navigator.userAgent.search("MSIE") && ha(a._resetButton.childNodes[0], { WebkitFilter: "invert(0%)", filter: "invert(0%)" }));
                          },
                          this.allDOMEventHandlers
                      ),
                        ...
                        if (this.options.axisY && 0 < this.options.axisY.length) {
                            if (!this.axisY.length)
                                for (var c = 0; c < this.options.axisY.length; c++)
                                    "normal" === this.plotInfo.axisPlacement
                                        ? this._axes.push((this.axisY[c] = new E(this, "axisY", this.options.axisY[c], c, "axisY", "left")))
                                        : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisY[c] = new E(this, "axisY", this.options.axisY[c], c, "axisY", "bottom")));
                        ...
                        if (this.options.axisY2 && 0 < this.options.axisY2.length) {
                            if (!this.axisY2.length)
                                for (c = 0; c < this.options.axisY2.length; c++)
                                    "normal" === this.plotInfo.axisPlacement
                                        ? this._axes.push((this.axisY2[c] = new E(this, "axisY2", this.options.axisY2[c], c, "axisY", "right")))
                                        : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisY2[c] = new E(this, "axisY2", this.options.axisY2[c], c, "axisY", "top")));
                        ...
                        if (this.options.axisX && 0 < this.options.axisX.length) {
                            if (!this.axisX.length)
                                for (c = 0; c < this.options.axisX.length; c++)
                                    "normal" === this.plotInfo.axisPlacement
                                        ? this._axes.push((this.axisX[c] = new E(this, "axisX", this.options.axisX[c], c, "axisX", "bottom")))
                                        : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX[c] = new E(this, "axisX", this.options.axisX[c], c, "axisX", "left")));
                        ...
                        if (this.options.axisX2 && 0 < this.options.axisX2.length) {
                            if (!this.axisX2.length)
                                for (c = 0; c < this.options.axisX2.length; c++)
                                    "normal" === this.plotInfo.axisPlacement
                                        ? this._axes.push((this.axisX2[c] = new E(this, "axisX2", this.options.axisX2[c], c, "axisX", "top")))
                                        : "xySwapped" === this.plotInfo.axisPlacement && this._axes.push((this.axisX2[c] = new E(this, "axisX2", this.options.axisX2[c], c, "axisX", "right")));
        ...
        n.prototype.renderElements = function () {
            ...
            this.animatedRender &&
                ...
                c.push({ source: this._breaksCanvasCtx, dest: this.plotArea.ctx, animationCallback: K.fadeInAnimation, easingFunction: K.easing.easeInQuad, animationBase: 0, startTimePercent: 0.7 });
        ...
        n.prototype._processStackedPlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f = !1, l = [], t = [], B = Infinity, k = -Infinity, m = 0; m < a.dataSeriesIndexes.length; m++) {
                ...
                for (q in l)
                    l.hasOwnProperty(q) &&
                        ...
                        a > d.max && (d.max = a),
                        q < c.viewPortMin || q > c.viewPortMax || (a < d.viewPortMin && (d.viewPortMin = Math.min(a, B)), a > d.viewPortMax && (d.viewPortMax = a)));
                for (q in t)
                    t.hasOwnProperty(q) &&
                        !isNaN(q) &&
                        ((a = t[q]),
        ...
        n.prototype._processStacked100PlotUnit = function (a) {
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
                    ...
                    for (p = 0; p < m.dataPoints.length; p++) {
                        ...
                        if (0 < p) {
                            ...
                            s(e) ||
                                ...
                                (a.axisY.logarithmic
                                    ? 0 < e && ((u = e / m.dataPoints[p - 1].y), 1 > u && (u = 1 / u), d.minDiff > u && 1 !== u && (d.minDiff = u))
                                    : ((u = e - m.dataPoints[p - 1].y), 0 > u && (u *= -1), d.minDiff > u && 0 !== u && (d.minDiff = u)));
                        }
                        if (b < h && !q) null !== e && (r = b);
                        else {
                            if (!q && ((q = !0), 0 < p)) {
                ...
                a.axisY.logarithmic
                    ...
                    : !l && t && ((d.max = s(d.viewPortMax) ? -1 : Math.max(d.viewPortMax, -1)), (d.min = s(d.viewPortMin) ? -99 : Math.min(d.viewPortMin, -99)));
                d.viewPortMin = d.min;
                d.viewPortMax = d.max;
                a.dataPointYSums = B;
            }
            ...
            if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                for (var d = a.axisY.dataInfo, c = a.axisX.dataInfo, b, e, f, l, t = !1, B = 0; B < a.dataSeriesIndexes.length; B++) {
                    ...
                    for (m = 0; m < k.dataPoints.length; m++) {
                        ...
                        0 < m &&
                            (a.axisX.logarithmic
                                ? ((r = b / k.dataPoints[m - 1].x), 1 > r && (r = 1 / r), c.minDiff > r && 1 !== r && (c.minDiff = r))
                                : ((r = b - k.dataPoints[m - 1].x), 0 > r && (r *= -1), c.minDiff > r && 0 !== r && (c.minDiff = r)),
                            e &&
                                null !== e[0] &&
                                k.dataPoints[m - 1].y &&
                        ...
                        if (!(4 > m.dataPoints.length))
                            for (k = 0; k < m.dataPoints.length; k++)
                                (g = ((d + 1 - c) * Math.max(parseFloat(a.axisX.scaleBreaks.collapsibleThreshold) || 10, 10)) / 100),
                                    (b = m.dataPoints[k].x.getTime ? m.dataPoints[k].x.getTime() : m.dataPoints[k].x),
                                    (g = Math.floor((b - c) / g)),
                                    b < f[g].min && (f[g].min = b),
                                    b > f[g].max && (f[g].max = b);
                    }
        ...
        n.prototype._mouseEventHandler = function (a) {
            ...
            n.capturedEventParam &&
                ...
                "mouseup" === c && ((n.capturedEventParam = null), b.chart.overlaidCanvas.releaseCapture ? b.chart.overlaidCanvas.releaseCapture() : document.documentElement.removeEventListener("mouseup", b.chart._mouseEventHandler, !1)),
                b.hasOwnProperty(c) &&
                    ("mouseup" !== c || b.chart.overlaidCanvas.releaseCapture ? (a.target !== b.chart.overlaidCanvas && w) || b[c].call(b.context, d.x, d.y) : a.target !== b.chart.overlaidCanvas && (b.chart.isDrag = !1)));
                            ...
                            if (this._events[f].hasOwnProperty(c))
                                if (((b = this._events[f]), (e = b.bounds), d.x >= e.x1 && d.x <= e.x2 && d.y >= e.y1 && d.y <= e.y2)) {
                                    ...
                                    "mousedown" === c && !0 === b.capture
                                        ? ((n.capturedEventParam = b), this.overlaidCanvas.setCapture ? this.overlaidCanvas.setCapture() : document.documentElement.addEventListener("mouseup", this._mouseEventHandler, !1))
                    ...
                    if (d.x < c.x1 || d.x > c.x2 || d.y < c.y1 || d.y > c.y2) {
                        ...
                        for (f = 0; f < this.axisX2.length; f++)
                            this.axisX2[f].crosshair &&
                                ...
                                (this.axisX2[f].crosshair.hide(), this.axisX2[f].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisX2[f].options }, this.axisX2[f].crosshair));
                        for (f = 0; f < this.axisY.length; f++)
                            this.axisY[f].crosshair &&
                                this.axisY[f].crosshair.enabled &&
                                (this.axisY[f].crosshair.hide(), this.axisY[f].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisY[f].options }, this.axisY[f].crosshair));
                        for (f = 0; f < this.axisY2.length; f++)
                            this.axisY2[f].crosshair &&
                                this.axisY2[f].crosshair.enabled &&
                                (this.axisY2[f].crosshair.hide(), this.axisY2[f].crosshair.dispatchEvent("hidden", { chart: this, axis: this.axisY2[f].options }, this.axisY2[f].crosshair));
                    }
        ...
        n.prototype.validateRegion = function (a, d, c, b, e) {
            e = e || !1;
            for (var f = 0 <= this.zoomType.indexOf("x"), l = 0 <= this.zoomType.indexOf("y"), t = !1, B = [], k = [], m = [], p = 0; p < this._axes.length; p++)
            ...
            for (a = 0; a < this._indexLabels.length; a++) {
                ...
                if (null !== D && "" !== D) {
                    ...
                    if ("normal" === this.plotInfo.axisPlacement) {
                        if (0 <= p.indexOf("line") || 0 <= p.indexOf("area")) (A = "auto"), (t = 4);
                        ...
                        "inside" !== A
                            ? ((e = c.y1),
                              (f = c.y2),
                              0 < v
                                  ? ((g = m.point.y + ("horizontal" === C ? r / 2 : 0) - k - t - b), g < e && ((g = "auto" === A ? Math.max(m.point.y, e) + r / 2 + t : e + r / 2 + t), (y = g + k > m.point.y)))
                                  : ((g = m.point.y + r / 2 + t + b), g > f - k && ((g = "auto" === A ? Math.min(m.point.y, f) + r / 2 - k - t : f + r / 2 - k), (y = g < m.point.y))))
                            : ((e = Math.max(m.bounds.y1, c.y1)),
                              ...
                              (b =
                                  0 <= p.indexOf("range") || "error" === p
                                      ...
                                      : (Math.max(m.bounds.y1, c.y1) + Math.min(m.bounds.y2, c.y2)) / 2 - k / 2 + r / 2 + ("horizontal" === C ? t : 0)),
                              0 < v
                                  ? ((g = Math.max(m.point.y, b)), g < e && ("bubble" === p || "scatter" === p) && (g = Math.max(m.point.y - k - t, c.y1 + t)))
                                  : ((g = Math.min(m.point.y, b)), g > f - k - t && ("bubble" === p || "scatter" === p) && (g = Math.min(m.point.y + t, c.y2 - k - t))),
                              (g = Math.min(g, f)));
                    } else
                        0 <= p.indexOf("line") || 0 <= p.indexOf("area") || 0 <= p.indexOf("scatter") ? ((A = "auto"), (l = 4)) : 0 <= p.indexOf("stacked") ? "auto" === A && (A = "inside") : "bubble" === p && (A = "inside"),
                            (g = m.point.y + r / 2 - k / 2 + t),
                            "inside" !== A
                                ? ((e = c.x1),
                                  (f = c.x2),
                                  0 > v
                                      ? ((q = m.point.x - ("horizontal" === C ? B : B - r / 2) - l - b), q < e && ((q = "auto" === A ? Math.max(m.point.x, e) + l : e + l), (y = q + B > m.point.x)))
                                      : ((q = m.point.x + ("horizontal" === C ? 0 : r / 2) + l + b),
                                        q > f - B - l - b && ((q = "auto" === A ? Math.min(m.point.x, f) - ("horizontal" === C ? B : B / 2) - l : f - B - l), (y = q < m.point.x))))
                                  ...
                                  (b =
                                      0 <= p.indexOf("range") || "error" === p
                                          ? 0 > v
                                              ...
                                              : Math.min(m.bounds.x2, c.x2) - B / 2 - l + ("horizontal" === C ? 0 : r / 2)
                                          : (Math.max(m.bounds.x1, c.x1) + Math.min(m.bounds.x2, c.x2)) / 2 + ("horizontal" === C ? 0 : r / 2)),
                                  (q = 0 > v ? Math.max(m.point.x, b) - ("horizontal" === C ? B / 2 : 0) : Math.min(m.point.x, b) - B / 2),
                                  (q = Math.max(q, e)));
                    "vertical" === C && (g += k - r / 2);
                    h.x = q;
                    h.y = g;
                    ...
                    x &&
                        "inside" !== A &&
                        ((0 > p.indexOf("bar") && ("error" !== p || !m.axisSwapped) && m.point.x > c.x1 && m.point.x < c.x2) || !y) &&
                        ((0 > p.indexOf("column") && ("error" !== p || m.axisSwapped) && m.point.y > c.y1 && m.point.y < c.y2) || !y) &&
                        ((d.lineWidth = x),
                        ...
                        0 <= p.indexOf("bar") || ("error" === p && m.axisSwapped)
                            ? d.lineTo(q + (0 < m.direction ? -l : B + l) + ("vertical" === C ? -r / 2 : 0), g + ("vertical" === C ? -k / 2 : k / 2 - r / 2) - t)
                            : 0 <= p.indexOf("column") || ("error" === p && !m.axisSwapped)
                            ? d.lineTo(q + B / 2 - ("horizontal" === C ? 0 : r / 2), g + ("vertical" === C ? (g - k < m.point.y ? 0 : -k) + t : (g - r / 2 < m.point.y ? k : 0) - r / 2))
                            : d.lineTo(q + B / 2 - ("horizontal" === C ? 0 : r / 2), g + ("vertical" === C ? (g - k < m.point.y ? 0 : -k) : (g - r / 2 < m.point.y ? k : 0) - r / 2)),
                        d.stroke());
                }
            }
                                    ...
                                    n || C
                                        ? (!n && k.connectNullData
                                              ? (c.setLineDash &&
                                                ...
                                                c.lineTo(x, s),
                                                w && b.lineTo(x, s))
                                              : (c.beginPath(), c.moveTo(x, s), w && (b.beginPath(), b.moveTo(x, s))),
                                          (C = n = !1))
                                        : (c.lineTo(x, s), w && b.lineTo(x, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), w && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                                    l = { x: x, y: s };
                                    u < m.length - 1 &&
                                        (h !== (m[u].lineColor || r) || p !== (m[u].lineDashType || k.lineDashType)) &&
                                        (c.stroke(),
                                        c.beginPath(),
                                        c.moveTo(x, s),
                                        (h = m[u].lineColor || r),
                                        (c.strokeStyle = h),
                                        c.setLineDash && (m[u].lineDashType ? ((p = m[u].lineDashType), c.setLineDash(N(p, k.lineThickness))) : ((p = k.lineDashType), c.setLineDash(g))));
                                    if (0 < m[u].markerSize || 0 < k.markerSize) {
                                        var z = k.getMarkerProperties(u, x, s, c);
                                        f.push(z);
                                        D = P(D);
                                        w && f.push({ x: x, y: s, ctx: b, type: z.type, size: z.size, color: D, borderColor: D, borderThickness: z.borderThickness });
                                    }
                                ...
                                if ("number" !== typeof m[u].y) 0 < u && !(k.connectNullData || C || n) && (c.stroke(), w && b.stroke()), (C = !0);
                                    ...
                                    n || C
                                        ? (!n && k.connectNullData
                                              ...
                                              : (c.beginPath(), c.moveTo(x, s), w && (b.beginPath(), b.moveTo(x, s))),
                                          (C = n = !1))
                                        : (c.lineTo(x, D), w && b.lineTo(x, D), c.lineTo(x, s), w && b.lineTo(x, s), 0 == u % 500 && (c.stroke(), c.beginPath(), c.moveTo(x, s), w && (b.stroke(), b.beginPath(), b.moveTo(x, s))));
                                    l = { x: x, y: s };
                                    u < m.length - 1 &&
                                        (h !== (m[u].lineColor || r) || p !== (m[u].lineDashType || k.lineDashType)) &&
                                        (c.stroke(),
                                        ...
                                        c.setLineDash && (m[u].lineDashType ? ((p = m[u].lineDashType), c.setLineDash(N(p, k.lineThickness))) : ((p = k.lineDashType), c.setLineDash(g))));
                                    if (0 < m[u].markerSize || 0 < k.markerSize)
                                        (D = k.getMarkerProperties(u, x, s, c)), f.push(D), (z = P(z)), w && f.push({ x: x, y: s, ctx: b, type: D.type, size: D.size, color: z, borderColor: z, borderThickness: D.borderThickness });
                                    (m[u].indexLabel || k.indexLabel || m[u].indexLabelFormatter || k.indexLabelFormatter) &&
                ...
                for (var l = [], t = 0; t < a.dataSeriesIndexes.length; t++) {
                    ...
                    if (0 < m.length)
                        for (x = !1, n = 0; n < m.length; n++)
                            if (((u = m[n].getTime ? m[n].x.getTime() : m[n].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !x)))))
                                if ("number" !== typeof m[n].y)
                                    0 < n &&
                                        !x &&
                                        (k.connectNullData
                                            ? b.setLineDash && 0 < s.length && (k.options.nullDataLineDashType || !m[n - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = q), (p = k.nullDataLineDashType))
                                            : (d(s), (s = []))),
                                        (x = !0);
                                else {
                                    ...
                                    this._eventManager.objectMap[C] = { id: C, objectType: "dataPoint", dataSeriesIndex: B, dataPointIndex: n, x1: u, y1: x };
                                    s[s.length] = { x: u, y: x };
                                    n < m.length - 1 &&
                                        (h !== (m[n].lineColor || r) || p !== (m[n].lineDashType || k.lineDashType)) &&
                                        ((h = m[n].lineColor || r),
                                        (s[s.length - 1].newStrokeStyle = h),
                                        b.setLineDash && (m[n].lineDashType ? ((p = m[n].lineDashType), (s[s.length - 1].newLineDashArray = N(p, k.lineThickness))) : ((p = k.lineDashType), (s[s.length - 1].newLineDashArray = g))));
                                    if (0 < m[n].markerSize || 0 < k.markerSize) {
                                        var D = k.getMarkerProperties(n, u, x, b);
                                        l.push(D);
                                        C = P(C);
                                        w && l.push({ x: u, y: x, ctx: e, type: D.type, size: D.size, color: C, borderColor: C, borderThickness: D.borderThickness });
                                    }
                                    (m[n].indexLabel || k.indexLabel || m[n].indexLabelFormatter || k.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "spline", dataPoint: m[n], dataSeries: k, point: { x: u, y: x }, direction: 0 > m[n].y === a.axisY.reversed ? 1 : -1, color: r });
                                    x = !1;
                                }
                    d(s);
                }
                            ...
                            if ((r[f].getTime ? (B = r[f].x.getTime()) : (B = r[f].x), !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y)) {
                                ...
                                (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        bounds: { x1: l, y1: Math.min(t, u), x2: n, y2: Math.max(t, u) },
                                        color: b,
                                    });
                            }
                }
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                var s = (m - (a.plotType.plotUnits.length * g) / 2 + a.index * g) << 0,
                                    C = (s + g) << 0,
                                    D;
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y))
                                    ...
                                    D = q - z;
                                    f[b] = z + (D - p);
                                } else (z = l[b] ? l[b] : 0), (D = p + z), (p = q + z), (l[b] = z + (D - p));
                                b = u[k].color ? u[k].color : n._colorSet[k % n._colorSet.length];
                                $(c, s, p, C, D, b, 0, null, x && 0 <= u[k].y, 0 > u[k].y && x, !1, !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: s, y1: p, x2: C, y2: D };
                                b = P(b);
                                w && $(this._eventManager.ghostCtx, s, p, C, D, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || n.indexLabel || u[k].indexLabelFormatter || n.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        bounds: { x1: s, y1: Math.min(p, D), x2: C, y2: Math.max(p, D) },
                                        color: b,
                                    });
                            }
                    }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var r = 0; r < a.dataSeriesIndexes.length; r++) {
                    var h = a.dataSeriesIndexes[r],
                        ...
                        u = n.dataPoints;
                    if (0 < u.length)
                        for (var x = 5 < g && n.bevelEnabled ? !0 : !1, k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                m = a.axisX.convertValueToPixel(b);
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)) {
                                    ...
                                    f[b] = z + (D - p);
                                } else (z = "undefined" !== typeof l[b] ? l[b] : 0), (D = p + z), (p = q + z), a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.y2 - D) && (D = e.y2), (l[b] = z + (D - p));
                                b = u[k].color ? u[k].color : n._colorSet[k % n._colorSet.length];
                                $(c, s, p, C, D, b, 0, null, x && 0 <= u[k].y, 0 > u[k].y && x, !1, !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: s, y1: p, x2: C, y2: D };
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if ((r[f].getTime ? (B = r[f].x.getTime()) : (B = r[f].x), !(B < a.axisX.dataInfo.viewPortMin || B > a.axisX.dataInfo.viewPortMax) && "number" === typeof r[f].y)) {
                                ...
                                b = P(b);
                                w && $(this._eventManager.ghostCtx, u, t, l, n, b, 0, null, !1, !1, !1, !1);
                                (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "bar",
                                        dataPoint: r[f],
                                        ...
                                        direction: 0 > r[f].y === a.axisY.reversed ? 1 : -1,
                                        bounds: { x1: Math.min(u, l), y1: t, x2: Math.max(u, l), y2: n },
                                        color: b,
                                    });
                            }
                    }
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                ...
                                var s = (p - (a.plotType.plotUnits.length * g) / 2 + a.index * g) << 0,
                                    ...
                                    D;
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y))
                                    (t[b] = u[k].y + (t[b] ? t[b] : 0)), 0 < t[b] && ((D = f[b] ? f[b] : q), (f[b] = m = a.axisY.convertValueToPixel(t[b])));
                                else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) (B[b] = u[k].y + (B[b] ? B[b] : 0)), (m = l[b] ? l[b] : q), (l[b] = D = a.axisY.convertValueToPixel(B[b]));
                                else if (((m = a.axisY.convertValueToPixel(u[k].y)), 0 <= u[k].y)) {
                                    var z = f[b] ? f[b] : 0;
                                    D = q + z;
                                    m += z;
                                    f[b] = z + (m - D);
                                } else (z = l[b] ? l[b] : 0), (D = m - z), (m = q - z), (l[b] = z + (m - D));
                                b = u[k].color ? u[k].color : n._colorSet[k % n._colorSet.length];
                                $(c, D, s, m, C, b, 0, null, x, !1, !1, !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: D, y1: s, x2: m, y2: C };
                                b = P(b);
                                w && $(this._eventManager.ghostCtx, D, s, m, C, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || n.indexLabel || u[k].indexLabelFormatter || n.indexLabelFormatter) &&
                                    this._indexLabels.push({
                    ...
                    if (0 < u.length) {
                        ...
                        for (k = 0; k < u.length; k++)
                            if (((b = u[k].x.getTime ? u[k].x.getTime() : u[k].x), !(b < a.axisX.dataInfo.viewPortMin || b > a.axisX.dataInfo.viewPortMax) && "number" === typeof u[k].y)) {
                                p = a.axisX.convertValueToPixel(b);
                                var A;
                                A = 0 !== a.dataPointYSums[b] ? 100 * (u[k].y / a.dataPointYSums[b]) : 0;
                                ...
                                if (a.axisY.logarithmic || (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 < u[k].y)) {
                                ...
                                } else if (a.axisY.scaleBreaks && 0 < a.axisY.scaleBreaks._appliedBreaks.length && 0 >= u[k].y) (B[b] = A + (B[b] ? B[b] : 0)), (m = l[b] ? l[b] : q), (l[b] = A = a.axisY.convertValueToPixel(B[b]));
                                    ...
                                    f[b] = z + (m - A);
                                } else (z = l[b] ? l[b] : 0), (A = m - z), (m = q - z), a.dataSeriesIndexes.length - 1 === r && 1 >= Math.abs(e.x1 - A) && (A = e.x1), (l[b] = z + (m - A));
                                b = u[k].color ? u[k].color : n._colorSet[k % n._colorSet.length];
                                $(c, A, C, m, D, b, 0, null, s, !1, !1, !1, n.fillOpacity);
                                b = n.dataPointIds[k];
                                this._eventManager.objectMap[b] = { id: b, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: k, x1: A, y1: C, x2: m, y2: D };
                                b = P(b);
                                w && $(this._eventManager.ghostCtx, A, C, m, D, b, 0, null, !1, !1, !1, !1);
                                (u[k].indexLabel || n.indexLabel || u[k].indexLabelFormatter || n.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                    ...
                                    d || ja
                                        ? (!d && g.connectNullData
                                              ? (f.setLineDash &&
                                                    ...
                                                    ((d = n), (c = u), (n = m.x), (u = m.y), b(), f.moveTo(m.x, m.y), (n = d), (u = c), (D = m), (c = g.nullDataLineDashType), f.setLineDash(Q)),
                                                f.lineTo(n, u),
                                                w && l.lineTo(n, u))
                                              : (f.beginPath(), f.moveTo(n, u), w && (l.beginPath(), l.moveTo(n, u)), (D = { x: n, y: u })),
                                          (ja = d = !1))
                                        : (f.lineTo(n, u), w && l.lineTo(n, u), 0 == h % 250 && b());
                                    m = { x: n, y: u };
                                    h < r.length - 1 &&
                                        (y !== (r[h].lineColor || v) || c !== (r[h].lineDashType || g.lineDashType)) &&
                                        (b(),
                                        (y = r[h].lineColor || v),
                                        (f.strokeStyle = y),
                                        f.setLineDash && (r[h].lineDashType ? ((c = r[h].lineDashType), f.setLineDash(N(c, g.lineThickness))) : ((c = g.lineDashType), f.setLineDash(aa))));
                                    var Y = g.dataPointIds[h];
                                    this._eventManager.objectMap[Y] = { id: Y, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: n, y1: u };
                                    0 !== r[h].markerSize &&
                                        (0 < r[h].markerSize || 0 < g.markerSize) &&
                                        ((s = g.getMarkerProperties(h, n, u, f)), B.push(s), (Y = P(Y)), w && B.push({ x: n, y: u, ctx: l, type: s.type, size: s.size, color: Y, borderColor: Y, borderThickness: s.borderThickness }));
                                    (r[h].indexLabel || g.indexLabel || r[h].indexLabelFormatter || g.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "area", dataPoint: r[h], dataSeries: g, point: { x: n, y: u }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, color: z });
                                }
                        b();
                        V.drawMarkers(B);
                    }
        ...
        n.prototype.renderSplineArea = function (a) {
            function d() {
                ...
                if (0 < c.length) {
                    ...
                    a.axisY.logarithmic || (0 >= a.axisY.viewportMinimum && 0 <= a.axisY.viewportMaximum) ? (n = h) : 0 > a.axisY.viewportMaximum ? (n = f.y1) : 0 < a.axisY.viewportMinimum && (n = h);
                    u = { x: c[0].x, y: c[0].y };
                            ...
                            if (((g = p[q].x.getTime ? p[q].x.getTime() : p[q].x), !(g < a.axisX.dataInfo.viewPortMin || (g > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !r)))))
                                if ("number" !== typeof p[q].y)
                                    0 < q &&
                                        !r &&
                                        (m.connectNullData
                                            ? b.setLineDash && 0 < s.length && (m.options.nullDataLineDashType || !p[q - 1].lineDashType) && ((s[s.length - 1].newLineDashArray = y), (z = m.nullDataLineDashType))
                                            : (d(), (s = []))),
                                        (r = !0);
                                else {
                                    ...
                                    s[s.length] = { x: g, y: r };
                                    q < p.length - 1 &&
                                        (D !== (p[q].lineColor || C) || z !== (p[q].lineDashType || m.lineDashType)) &&
                                        ((D = p[q].lineColor || C),
                                        (s[s.length - 1].newStrokeStyle = D),
                                        b.setLineDash && (p[q].lineDashType ? ((z = p[q].lineDashType), (s[s.length - 1].newLineDashArray = N(z, m.lineThickness))) : ((z = m.lineDashType), (s[s.length - 1].newLineDashArray = E))));
                                    ...
                                    (p[q].indexLabel || m.indexLabel || p[q].indexLabelFormatter || m.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "splineArea", dataPoint: p[q], dataSeries: m, point: { x: g, y: r }, direction: 0 > p[q].y === a.axisY.reversed ? 1 : -1, color: A });
                                    r = !1;
                                }
                        d();
                        V.drawMarkers(l);
                                ...
                                "number" !== typeof r[h].y
                                    ...
                                    : ((n = a.axisX.convertValueToPixel(s)),
                                      ...
                                      d || c
                                          ? (!d && g.connectNullData
                                                ? (f.setLineDash &&
                                                      (g.options.nullDataLineDashType || (Q === g.lineDashType && g.lineDashType !== g.nullDataLineDashType)) &&
                                                      ((d = n), (c = u), (n = m.x), (u = m.y), b(), f.moveTo(m.x, m.y), (n = d), (u = c), (D = m), (Q = g.nullDataLineDashType), f.setLineDash(aa)),
                                                  f.lineTo(n, Y),
                                                  f.lineTo(n, u),
                                                  w && (l.lineTo(n, Y), l.lineTo(n, u)))
                                                : (f.beginPath(), f.moveTo(n, u), w && (l.beginPath(), l.moveTo(n, u)), (D = { x: n, y: u })),
                                            (c = d = !1))
                                          : (f.lineTo(n, Y), w && l.lineTo(n, Y), f.lineTo(n, u), w && l.lineTo(n, u), 0 == h % 250 && b()),
                                      (m = { x: n, y: u }),
                                      h < r.length - 1 &&
                                          (y !== (r[h].lineColor || v) || Q !== (r[h].lineDashType || g.lineDashType)) &&
                                          (b(),
                                          (y = r[h].lineColor || v),
                                          (f.strokeStyle = y),
                                          f.setLineDash && (r[h].lineDashType ? ((Q = r[h].lineDashType), f.setLineDash(N(Q, g.lineThickness))) : ((Q = g.lineDashType), f.setLineDash(E)))),
                                      (s = g.dataPointIds[h]),
                                      (this._eventManager.objectMap[s] = { id: s, objectType: "dataPoint", dataSeriesIndex: q, dataPointIndex: h, x1: n, y1: u }),
                                      0 !== r[h].markerSize &&
                                          (0 < r[h].markerSize || 0 < g.markerSize) &&
                                          ((Y = g.getMarkerProperties(h, n, u, f)), B.push(Y), (s = P(s)), w && B.push({ x: n, y: u, ctx: l, type: Y.type, size: Y.size, color: s, borderColor: s, borderThickness: Y.borderThickness })),
                                      (r[h].indexLabel || g.indexLabel || r[h].indexLabelFormatter || g.indexLabelFormatter) &&
                                          this._indexLabels.push({ chartType: "stepArea", dataPoint: r[h], dataSeries: g, point: { x: n, y: u }, direction: 0 > r[h].y === a.axisY.reversed ? 1 : -1, color: z }));
                            }
                        b();
                        V.drawMarkers(B);
                    }
                            ...
                            if (!(f < a.axisX.dataInfo.viewPortMin || (f > a.axisX.dataInfo.viewPortMax && (!z.connectNullData || !Y))))
                                if ("number" !== typeof fa.y) z.connectNullData || Y || x || d(), (Y = !0);
                                    ...
                                    x || Y
                                        ? (!x && z.connectNullData
                                              ? (b.setLineDash &&
                                                    ...
                                                    ((x = k.pop()), (A = k[k.length - 1]), d(), b.moveTo(u.x, u.y), k.push(A), k.push(x), (A = z.nullDataLineDashType), b.setLineDash(aa)),
                                                b.lineTo(g, r),
                                                w && s.lineTo(g, r))
                                              : (b.beginPath(), b.moveTo(g, r), w && (s.beginPath(), s.moveTo(g, r))),
                                          (Y = x = !1))
                                        : (b.lineTo(g, r), w && s.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && s.moveTo(g, r), k.push({ x: g, y: n - ma })));
                                    u = { x: g, y: r };
                                    q < v.length - 1 &&
                                        ...
                                        (Q = v[q].lineColor || y),
                                        (b.strokeStyle = Q),
                                        b.setLineDash && (v[q].lineDashType ? ((A = v[q].lineDashType), b.setLineDash(N(A, z.lineThickness))) : ((A = z.lineDashType), b.setLineDash(E))));
                                    if (0 <= z.dataPointIndexes[f]) {
                                        var F = z.dataPointIds[z.dataPointIndexes[f]];
                                        this._eventManager.objectMap[F] = { id: F, objectType: "dataPoint", dataSeriesIndex: D, dataPointIndex: z.dataPointIndexes[f], x1: g, y1: r };
                                    }
                                    0 <= z.dataPointIndexes[f] &&
                                        ...
                                        l.push(ma),
                                        (f = P(F)),
                                        w && l.push({ x: g, y: r, ctx: s, type: ma.type, size: ma.size, color: f, borderColor: f, borderThickness: ma.borderThickness }));
                                    (fa.indexLabel || z.indexLabel || fa.indexLabelFormatter || z.indexLabelFormatter) &&
                                        this._indexLabels.push({ chartType: "stackedArea", dataPoint: fa, dataSeries: z, point: { x: g, y: r }, direction: 0 > v[q].y === a.axisY.reversed ? 1 : -1, color: e });
                                }
                        }
                        d();
                        b.moveTo(g, r);
                                    ...
                                    s || Y
                                        ? (!s && z.connectNullData
                                              ? (b.setLineDash &&
                                                    ...
                                                    ((s = k.pop()), (u = k[k.length - 1]), d(), b.moveTo(n.x, n.y), k.push(u), k.push(s), (u = z.nullDataLineDashType), b.setLineDash(aa)),
                                                b.lineTo(g, r),
                                                w && A.lineTo(g, r))
                                              : (b.beginPath(), b.moveTo(g, r), w && (A.beginPath(), A.moveTo(g, r))),
                                          (Y = s = !1))
                                        : (b.lineTo(g, r), w && A.lineTo(g, r), 0 == q % 250 && (d(), b.moveTo(g, r), w && A.moveTo(g, r), k.push({ x: g, y: x - ba })));
                                    n = { x: g, y: r };
                                    q < y.length - 1 &&
                                        ...
                                        (Q = y[q].lineColor || E),
                                        (b.strokeStyle = Q),
                                        b.setLineDash && (y[q].lineDashType ? ((u = y[q].lineDashType), b.setLineDash(N(u, z.lineThickness))) : ((u = z.lineDashType), b.setLineDash(F))));
                                    if (0 <= z.dataPointIndexes[f]) {
                                        var G = z.dataPointIds[z.dataPointIndexes[f]];
                                        this._eventManager.objectMap[G] = { id: G, objectType: "dataPoint", dataSeriesIndex: v, dataPointIndex: z.dataPointIndexes[f], x1: g, y1: r };
                                    }
                                    0 <= z.dataPointIndexes[f] &&
                                        0 !== fa.markerSize &&
                                        (0 < fa.markerSize || 0 < z.markerSize) &&
                                        ((ba = z.getMarkerProperties(q, g, r, b)), t.push(ba), (f = P(G)), w && t.push({ x: g, y: r, ctx: A, type: ba.type, size: ba.size, color: f, borderColor: f, borderThickness: ba.borderThickness }));
                                    (fa.indexLabel || z.indexLabel || fa.indexLabelFormatter || z.indexLabelFormatter) &&
                    ...
                    if (((m = a.dataSeriesIndexes[k]), (p = this.data[m]), (q = p.dataPoints), 0 < q.length))
                        for (c.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                            if (((f = q[e].getTime ? (f = q[e].x.getTime()) : (f = q[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[e].y)) {
                                ...
                                s = P(u);
                                w && V.drawMarker(f, l, this._eventManager.ghostCtx, g.type, g.size, s, s, g.borderThickness);
                    ...
                    if (0 < m.length) {
                        ...
                        for (var p = 0, q = 0, e = 0; e < m.length; e++)
                            if (((f = m[e].getTime ? (f = m[e].x.getTime()) : (f = m[e].x)), !(f < a.axisX.dataInfo.viewPortMin || f > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y)) {
                                ...
                                c.globalAlpha = 1;
                                (Math.sqrt((p - f) * (p - f) + (q - l) * (q - l)) < Math.min(g.size, 5) && m.length > Math.min(this.plotArea.width, this.plotArea.height)) ||
                                    ((p = k.dataPointIds[e]),
                                    (this._eventManager.objectMap[p] = { id: p, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: e, x1: f, y1: l }),
                                    (p = P(p)),
                                    w && V.drawMarker(g.x, g.y, this._eventManager.ghostCtx, g.type, g.size, p, p, g.borderThickness),
                        ...
                        for (var A = 5 < r && u.bevelEnabled ? !0 : !1, t = 0; t < x.length; t++)
                            if (
                                ...
                                var C = (h - r / 2) << 0,
                                    ...
                                    y = 0 === z % 2 ? 0 : 0.5,
                                    E = u.dataPointIds[t];
                                this._eventManager.objectMap[E] = { id: E, objectType: "dataPoint", dataSeriesIndex: v, dataPointIndex: t, x1: C, y1: k, x2: D, y2: m, x3: h, y3: p, x4: h, y4: q, borderThickness: z, color: e };
                                c.strokeStyle = e;
                                c.beginPath();
                                c.lineWidth = z;
                                ...
                                "candlestick" === u.type
                                    ? (c.moveTo(h - y, m),
                                      ...
                                      c.lineTo(h - y, p),
                                      c.stroke(),
                                      $(c, C, Math.min(k, q), D, Math.max(k, q), x[t].y[0] <= x[t].y[3] ? u.risingColor : f, z, e, A, A, !1, !1, u.fillOpacity),
                                      w &&
                                          ((e = P(E)),
                                          (b.strokeStyle = e),
                                          b.moveTo(h - y, m),
                                          ...
                                          b.lineTo(h - y, p),
                                          b.stroke(),
                                          $(b, C, Math.min(k, q), D, Math.max(k, q), e, 0, null, !1, !1, !1, !1)))
                                    : "ohlc" === u.type &&
                                      (c.moveTo(h - y, m),
                                      c.lineTo(h - y, p),
                                      c.stroke(),
                                ...
                                (x[t].indexLabel || u.indexLabel || x[t].indexLabelFormatter || u.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        ...
                                        direction: 1,
                                        bounds: { x1: C, y1: Math.min(m, p), x2: D, y2: Math.max(m, p) },
                                        color: e,
                                    });
                            }
                }
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var n = !1, n = !!a.axisY.reversed, v = 0; v < a.dataSeriesIndexes.length; v++) {
                    var u = a.dataSeriesIndexes[v],
                        ...
                        A = x.dataPoints;
                    if (0 < A.length)
                        for (var C = 5 < r && x.bevelEnabled ? !0 : !1, l = 0; l < A.length; l++)
                            if (
                                ...
                                var D = (t - r / 2) << 0,
                                    ...
                                    E = 0 === y % 2 ? 0 : 0.5,
                                    Q = A[l].whiskerColor ? A[l].whiskerColor : A[l].color ? (x.whiskerColor ? x.whiskerColor : A[l].color) : x.whiskerColor ? x.whiskerColor : e,
                                    aa = "number" === typeof A[l].whiskerThickness ? A[l].whiskerThickness : "number" === typeof x.options.whiskerThickness ? x.whiskerThickness : y,
                                    F = A[l].whiskerDashType ? A[l].whiskerDashType : x.whiskerDashType,
                                    Y = s(A[l].whiskerLength) ? (s(x.options.whiskerLength) ? r : x.whiskerLength) : A[l].whiskerLength,
                                    Y = "number" === typeof Y ? (0 >= Y ? 0 : Y >= r ? r : Y) : "string" === typeof Y ? ((parseInt(Y) * r) / 100 > r ? r : (parseInt(Y) * r) / 100) : r,
                                    fa = 1 === Math.round(aa) % 2 ? 0.5 : 0,
                                    ma = A[l].stemColor ? A[l].stemColor : A[l].color ? (x.stemColor ? x.stemColor : A[l].color) : x.stemColor ? x.stemColor : e,
                                    ba = "number" === typeof A[l].stemThickness ? A[l].stemThickness : "number" === typeof x.options.stemThickness ? x.stemThickness : y,
                                    G = 1 === Math.round(ba) % 2 ? 0.5 : 0,
                                    J = A[l].stemDashType ? A[l].stemDashType : x.stemDashType,
                                    H = A[l].lineColor ? A[l].lineColor : A[l].color ? (x.lineColor ? x.lineColor : A[l].color) : x.lineColor ? x.lineColor : e,
                                    M = "number" === typeof A[l].lineThickness ? A[l].lineThickness : "number" === typeof x.options.lineThickness ? x.lineThickness : y,
                                ...
                                c.save();
                                0 < ba &&
                                    (c.beginPath(), (c.strokeStyle = ma), (c.lineWidth = ba), c.setLineDash && c.setLineDash(N(J, ba)), c.moveTo(t - G, k), c.lineTo(t - G, h), c.stroke(), c.moveTo(t - G, p), c.lineTo(t - G, m), c.stroke());
                                c.restore();
                                b.lineWidth = Math.max(y, 4);
                                c.beginPath();
                                $(c, D, Math.min(q, k), z, Math.max(k, q), xa, 0, e, n ? C : !1, n ? !1 : C, !1, !1, sa);
                                c.beginPath();
                                $(c, D, Math.min(m, q), z, Math.max(q, m), R, 0, e, n ? !1 : C, n ? C : !1, !1, !1, sa);
                                c.beginPath();
                                c.lineWidth = y;
                                c.strokeStyle = e;
                                c.rect(D - E, Math.min(k, m) - E, z - D + 2 * E, Math.max(k, m) - Math.min(k, m) + 2 * E);
                                c.stroke();
                                c.save();
                                0 < M && (c.beginPath(), (c.globalAlpha = 1), c.setLineDash && c.setLineDash(N(S, M)), (c.strokeStyle = H), (c.lineWidth = M), c.moveTo(D, q - L), c.lineTo(z, q - L), c.stroke());
                                c.restore();
                                c.save();
                                0 < aa &&
                                    (c.beginPath(),
                                ...
                                w &&
                                    ...
                                    (b.strokeStyle = e),
                                    (b.lineWidth = ba),
                                    0 < ba && (b.moveTo(t - E - G, k), b.lineTo(t - E - G, Math.max(h, p)), b.stroke(), b.moveTo(t - E - G, Math.min(h, p)), b.lineTo(t - E - G, m), b.stroke()),
                                    $(b, D, Math.max(k, m), z, Math.min(k, m), e, 0, null, !1, !1, !1, !1),
                                ...
                                (A[l].indexLabel || x.indexLabel || A[l].indexLabelFormatter || x.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: x.type,
                                        dataPoint: A[l],
                                        dataSeries: x,
                                        ...
                                        direction: 1,
                                        bounds: { x1: D, y1: Math.min(h, p), x2: z, y2: Math.max(h, p) },
                                        color: e,
                                    });
                            }
                }
                    ...
                    if (0 < g.length)
                        for (var r = 5 < k && q.bevelEnabled ? !0 : !1, f = 0; f < g.length; f++)
                            if (
                                ...
                                var n = a.axisX.reversed ? (b + (a.plotType.totalDataSeries * k) / 2 - (a.previousDataSeriesCount + m) * k) << 0 : (b - (a.plotType.totalDataSeries * k) / 2 + (a.previousDataSeriesCount + m) * k) << 0,
                                ...
                                b = P(u);
                                w && $(this._eventManager.ghostCtx, n, l, v, t, b, 0, null, !1, !1, !1, !1);
                                if (g[f].indexLabel || q.indexLabel || g[f].indexLabelFormatter || q.indexLabelFormatter)
                                    this._indexLabels.push({
                                        ...
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: q,
                                            indexKeyword: 1,
                                            point: { x: n + (v - n) / 2, y: g[f].y[1] >= g[f].y[0] ? l : t },
                                            direction: g[f].y[1] >= g[f].y[0] ? 1 : -1,
                                            bounds: { x1: n, y1: Math.min(l, t), x2: v, y2: Math.max(l, t) },
                                            color: b,
                                        });
        ...
        n.prototype.renderError = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var x = 0; x < a.dataSeriesIndexes.length; x++) {
                    ...
                    e = this.options.dataPointMinWidth ? this.dataPointMinWidth : this.options.dataPointWidth ? this.dataPointWidth : 1;
                    t = this.options.dataPointMaxWidth ? this.dataPointMaxWidth : this.options.dataPointWidth ? this.dataPointWidth : b ? Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / (z ? v : 1))) << 0 : 0.3 * this.width;
                    f &&
                        (t = this.options.dataPointMaxWidth
                            ...
                            : 0.03 * this.width);
                    u = this.options.dataPointWidth ? this.dataPointWidth : (0.9 * (((b ? l.height : l.width) * (a.axisX.logarithmic ? Math.log(n) / Math.log(a.axisX.range) : Math.abs(n) / Math.abs(a.axisX.range))) / (z ? v : 1))) << 0;
                    ...
                    if (0 < D.length)
                        for (var F = C._colorSet, t = 0; t < D.length; t++) {
                            ...
                            if (!(r < a.axisX.dataInfo.viewPortMin || r > a.axisX.dataInfo.viewPortMax) && !s(D[t].y) && D[t].y.length && "number" === typeof D[t].y[0] && "number" === typeof D[t].y[1]) {
                                ...
                                b ? (p = ja) : (g = ja);
                                b
                                    ? ((q = a.axisX.reversed ? (k + ((z ? v : 1) * u) / 2 - (z ? E - 1 : 0) * u) << 0 : (k - ((z ? v : 1) * u) / 2 + (z ? E - 1 : 0) * u) << 0), (g = a.axisX.reversed ? (q - u) << 0 : (q + u) << 0))
                                    : ((m = a.axisX.reversed ? (h + ((z ? v : 1) * u) / 2 - (z ? E - 1 : 0) * u) << 0 : (h - ((z ? v : 1) * u) / 2 + (z ? E - 1 : 0) * u) << 0), (p = a.axisX.reversed ? (m - u) << 0 : (m + u) << 0));
                                !b && q > g && ((ja = q), (q = g), (g = ja));
                                b && m > p && ((ja = m), (m = p), (p = ja));
                                ja = C.dataPointIds[t];
                                ...
                                y(c, Math.min(m, p), Math.min(q, g), Math.max(p, m), Math.max(g, q), e, Q, aa, b);
                                ...
                                if (D[t].indexLabel || C.indexLabel || D[t].indexLabelFormatter || C.indexLabelFormatter)
                                    this._indexLabels.push({
                                        ...
                                        dataSeries: C,
                                        indexKeyword: 0,
                                        point: { x: b ? (D[t].y[1] >= D[t].y[0] ? m : p) : m + (p - m) / 2, y: b ? q + (g - q) / 2 : D[t].y[1] >= D[t].y[0] ? g : q },
                                        direction: D[t].y[1] >= D[t].y[0] ? -1 : 1,
                                        bounds: { x1: b ? Math.min(m, p) : m, y1: b ? q : Math.min(q, g), x2: b ? Math.max(m, p) : p, y2: b ? g : Math.max(q, g) },
                                        color: e,
                                        axisSwapped: b,
                                    }),
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: C,
                                            indexKeyword: 1,
                                            point: { x: b ? (D[t].y[1] >= D[t].y[0] ? p : m) : m + (p - m) / 2, y: b ? q + (g - q) / 2 : D[t].y[1] >= D[t].y[0] ? q : g },
                                            direction: D[t].y[1] >= D[t].y[0] ? 1 : -1,
                                            bounds: { x1: b ? Math.min(m, p) : m, y1: b ? q : Math.min(q, g), x2: b ? Math.max(m, p) : p, y2: b ? g : Math.max(q, g) },
                                            color: e,
                                            axisSwapped: b,
                    ...
                    if (0 < r.length) {
                        ...
                        for (f = 0; f < r.length; f++)
                            if (
                                ...
                                b = P(b);
                                w && $(this._eventManager.ghostCtx, l, h, t, v, b, 0, null, !1, !1, !1, !1);
                                if (r[f].indexLabel || g.indexLabel || r[f].indexLabelFormatter || g.indexLabelFormatter)
                                    this._indexLabels.push({
                                        ...
                                        dataSeries: g,
                                        indexKeyword: 0,
                                        point: { x: r[f].y[1] >= r[f].y[0] ? l : t, y: h + (v - h) / 2 },
                                        ...
                                        this._indexLabels.push({
                                            ...
                                            dataSeries: g,
                                            indexKeyword: 1,
                                            point: { x: r[f].y[1] >= r[f].y[0] ? t : l, y: h + (v - h) / 2 },
                                            direction: r[f].y[1] >= r[f].y[0] ? 1 : -1,
                                            bounds: { x1: Math.min(l, t), y1: h, x2: Math.max(l, t), y2: v },
                                            color: b,
                                        });
                            ...
                            if (((u = p[g].x.getTime ? p[g].x.getTime() : p[g].x), !(u < a.axisX.dataInfo.viewPortMin || (u > a.axisX.dataInfo.viewPortMax && (!m.connectNullData || !Q)))))
                                if (null !== p[g].y && p[g].y.length && "number" === typeof p[g].y[0] && "number" === typeof p[g].y[1]) {
                                    ...
                                    q || Q
                                        ? (m.connectNullData && !q
                                              ? (b.setLineDash &&
                                                    ...
                                                    ((h[h.length - 1].newLineDashArray = E), (z = m.nullDataLineDashType), b.setLineDash(y)),
                                                b.lineTo(r, n),
                                                w && e.lineTo(r, n),
                                                h.push({ x: r, y1: n, y2: s }))
                                              : (b.beginPath(), b.moveTo(r, n), (x = { x: r, y: n }), (h = []), h.push({ x: r, y1: n, y2: s }), w && (e.beginPath(), e.moveTo(r, n))),
                                          (Q = q = !1))
                                        : (b.lineTo(r, n), h.push({ x: r, y1: n, y2: s }), w && e.lineTo(r, n), 0 == g % 250 && d());
                                    u = m.dataPointIds[g];
                                    this._eventManager.objectMap[u] = { id: u, objectType: "dataPoint", dataSeriesIndex: k, dataPointIndex: g, x1: r, y1: n, y2: s };
                                    g < p.length - 1 &&
                                        (D !== (p[g].lineColor || C) || z !== (p[g].lineDashType || m.lineDashType)) &&
                                        (d(),
                                        (D = p[g].lineColor || C),
                                        ...
                                        b.setLineDash &&
                                            (p[g].lineDashType
                                                ? ((z = p[g].lineDashType), (h[h.length - 1].newLineDashArray = N(z, m.lineThickness)), b.setLineDash(h[h.length - 1].newLineDashArray))
                                                : ((z = m.lineDashType), (h[h.length - 1].newLineDashArray = E), b.setLineDash(E))));
                                    ...
                                    if (p[g].indexLabel || m.indexLabel || p[g].indexLabelFormatter || m.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeArea", dataPoint: p[g], dataSeries: m, indexKeyword: 0, point: { x: r, y: n }, direction: p[g].y[0] > p[g].y[1] === a.axisY.reversed ? -1 : 1, color: v }),
                                            this._indexLabels.push({
                                                chartType: "rangeArea",
                                                dataPoint: p[g],
                                                dataSeries: m,
                    ...
                    if (0 < k.lineThickness) {
                        ...
                        for (var g = (f = 0); f < d.length - 3; f += 3, g++) {
                            if (n[g].newStrokeStyle || n[g].newLineDashArray)
                                b.stroke(), b.beginPath(), b.moveTo(d[f].x, d[f].y), n[g].newStrokeStyle && (b.strokeStyle = n[g].newStrokeStyle), n[g].newLineDashArray && b.setLineDash(n[g].newLineDashArray);
                            b.bezierCurveTo(d[f + 1].x, d[f + 1].y, d[f + 2].x, d[f + 2].y, d[f + 3].x, d[f + 3].y);
                        }
                        d = v(n, 2);
                        b.moveTo(d[0].x, d[0].y);
                        ...
                        for (g = !1; p < m.length; p++)
                            if (((q = m[p].x.getTime ? m[p].x.getTime() : m[p].x), !(q < a.axisX.dataInfo.viewPortMin || (q > a.axisX.dataInfo.viewPortMax && (!k.connectNullData || !g)))))
                                if (null !== m[p].y && m[p].y.length && "number" === typeof m[p].y[0] && "number" === typeof m[p].y[1]) {
                                    ...
                                    this._eventManager.objectMap[y] = { id: y, objectType: "dataPoint", dataSeriesIndex: h, dataPointIndex: p, x1: q, y1: g, y2: r };
                                    n[n.length] = { x: q, y: g };
                                    s[s.length] = { x: q, y: r };
                                    p < m.length - 1 &&
                                        (A !== (m[p].lineColor || x) || C !== (m[p].lineDashType || k.lineDashType)) &&
                                        ((A = m[p].lineColor || x),
                                        (n[n.length - 1].newStrokeStyle = A),
                                        b.setLineDash && (m[p].lineDashType ? ((C = m[p].lineDashType), (n[n.length - 1].newLineDashArray = N(C, k.lineThickness))) : ((C = k.lineDashType), (n[n.length - 1].newLineDashArray = D))));
                                    if (0 !== m[p].markerSize && (0 < m[p].markerSize || 0 < k.markerSize)) {
                                        var E = k.getMarkerProperties(p, q, g, b);
                                        f.push(E);
                                        var Q = P(y);
                                        w && f.push({ x: q, y: g, ctx: e, type: E.type, size: E.size, color: Q, borderColor: Q, borderThickness: E.borderThickness });
                                    ...
                                    if (m[p].indexLabel || k.indexLabel || m[p].indexLabelFormatter || k.indexLabelFormatter)
                                        this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: m[p], dataSeries: k, indexKeyword: 0, point: { x: q, y: g }, direction: m[p].y[0] <= m[p].y[1] ? -1 : 1, color: u }),
                                            this._indexLabels.push({ chartType: "rangeSplineArea", dataPoint: m[p], dataSeries: k, indexKeyword: 1, point: { x: q, y: r }, direction: m[p].y[0] <= m[p].y[1] ? 1 : -1, color: u });
                                    g = !1;
                                } else
                                    0 < p &&
                                        !g &&
                                        (k.connectNullData
                                            ? b.setLineDash && 0 < n.length && (k.options.nullDataLineDashType || !m[p - 1].lineDashType) && ((n[n.length - 1].newLineDashArray = z), (C = k.nullDataLineDashType))
                                            : (d(D, x), (n = []), (s = []))),
                                        (g = !0);
                        d(D, x);
                        V.drawMarkers(f);
        ...
        n.prototype.renderWaterfall = function (a) {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                for (var g = 0; g < a.dataSeriesIndexes.length; g++) {
                    ...
                    if (0 < v.length)
                        for (var A = 5 < q && s.bevelEnabled ? !0 : !1, C = !1, D = null, z = null, l = 0; l < v.length; l++)
                            if ((v[l].getTime ? (m = v[l].x.getTime()) : (m = v[l].x), "number" !== typeof v[l].y)) {
                                if (0 < l && !C && s.connectNullData) var y = s.options.nullDataLineDashType || !v[l - 1].lineDashType ? s.nullDataLineDashType : v[l - 1].lineDashType;
                                C = !0;
                            } else {
                                t = a.axisX.convertValueToPixel(m);
                                h = 0 === s.dataPointEOs[l].cumulativeSum ? p : a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);
                                k = 0 === s.dataPointEOs[l].cumulativeSumYStartValue ? p : a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue);
                                t = a.axisX.reversed ? (t + (a.plotType.totalDataSeries * q) / 2 - (a.previousDataSeriesCount + g) * q) << 0 : (t - (a.plotType.totalDataSeries * q) / 2 + (a.previousDataSeriesCount + g) * q) << 0;
                                var E = a.axisX.reversed ? (t - q) << 0 : (t + q) << 0;
                                h > k && ((e = h), (h = k), (k = e));
                                a.axisY.reversed && ((e = h), (h = k), (k = e));
                                e = s.dataPointIds[l];
                                this._eventManager.objectMap[e] = { id: e, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: l, x1: t, y1: h, x2: E, y2: k };
                                var Q = v[l].color ? v[l].color : 0 < v[l].y ? s.risingColor : s.fallingColor;
                                $(c, t, h, E, k, Q, 0, Q, A, A, !1, !1, s.fillOpacity);
                                e = P(e);
                                w && $(this._eventManager.ghostCtx, t, h, E, k, e, 0, null, !1, !1, !1, !1);
                                var aa,
                                    Q = t;
                                aa =
                                    ("undefined" !== typeof v[l].isIntermediateSum && !0 === v[l].isIntermediateSum) || ("undefined" !== typeof v[l].isCumulativeSum && !0 === v[l].isCumulativeSum)
                                        ? 0 < v[l].y
                                            ? h
                                            : k
                                        : 0 < v[l].y
                                ...
                                0 < l &&
                                    ...
                                    c.lineTo(Q, aa - x),
                                    0 < u && c.stroke(),
                                    w && (b.beginPath(), b.moveTo(D, z - x), b.lineTo(Q, aa - x), 0 < u && b.stroke()));
                                C = !1;
                                D = E;
                                z = 0 < v[l].y ? h : k;
                                Q = v[l].lineDashType ? v[l].lineDashType : s.options.lineDashType ? s.options.lineDashType : "shortDash";
                                ...
                                (v[l].indexLabel || s.indexLabel || v[l].indexLabelFormatter || s.indexLabelFormatter) &&
                                    this._indexLabels.push({
                                        chartType: "waterfall",
                                        dataPoint: v[l],
                                        dataSeries: s,
                                        ...
                                        bounds: { x1: t, y1: Math.min(h, k), x2: E, y2: Math.max(h, k) },
                                        color: e,
                                    });
                            }
                }
        ...
        var ga = function (a, d, c, b, e, f, l, h, n) {
            if (!(0 > c)) {
                ...
                "pie" === e
                    ...
                    : "doughnut" === e && (a.beginPath(), a.arc(d.x, d.y, c, f, l, !1), 0 <= n && a.arc(d.x, d.y, n * c, l, f, !0), a.closePath(), (a.fillStyle = b), (a.strokeStyle = "white"), (a.lineWidth = 2), a.fill());
                a.globalAlpha = 1;
                a.restore();
            }
        };
            ...
            function d() {
                if (k && m) {
                    ...
                    for (e = 0; e < m.length; e++)
                        (h = g[(c + e) % m.length]), 1 < a && h.midAngle > Math.PI / 2 - u && h.midAngle < Math.PI / 2 + u && (f <= a / 2 && !p ? ((h.hemisphere = "right"), f++) : ((h.hemisphere = "left"), (p = !0)));
                    p = !1;
                    for (e = 0; e < m.length; e++)
                        (h = g[(d + e) % m.length]), 1 < b && h.midAngle > (3 * Math.PI) / 2 - u && h.midAngle < (3 * Math.PI) / 2 + u && (l <= b / 2 && !p ? ((h.hemisphere = "left"), l++) : ((h.hemisphere = "right"), (p = !0)));
                }
            }
            function c(a) {
                ...
                for (b = 0; b < m.length; b++) {
                    ...
                    if (d > c) {
                        var e = 0.07 * z * Math.cos(g[b].midAngle),
                            ...
                            l = !1;
                        if (m[b].exploded) {
                            if (1e-9 < Math.abs(g[b].center.x - (A.x + e)) || 1e-9 < Math.abs(g[b].center.y - (A.y + f))) (g[b].center.x = A.x + e * a), (g[b].center.y = A.y + f * a), (l = !0);
                        ...
                        ga(n.plotArea.ctx, g[b].center, g[b].radius, m[b].color ? m[b].color : k._colorSet[b % k._colorSet.length], k.type, c, d, k.fillOpacity, g[b].percentInnerRadius);
                    }
                }
                a = n.plotArea.ctx;
                a.save();
            ...
            function f(a, c, d) {
                ...
                if (0 <= a && a < m.length) {
                    ...
                    var q = 0,
                        ...
                        t = (q = q = 0);
                    0 > c
                        ? p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 > l && p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 + c < l && (c = -(l - (p.indexLabelTextBlock.y - p.indexLabelTextBlock.height / 2 + c)))
                        : p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 < l && p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + c > h && (c = p.indexLabelTextBlock.y + p.indexLabelTextBlock.height / 2 + c - h);
                    c = p.indexLabelTextBlock.y + c;
                    l = 0;
                    l = "right" === p.hemisphere ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(c - A.y, 2)) : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(c - A.y, 2));
                    ...
                    0 > c
                        ? ((h = "right" === p.hemisphere ? t : q),
                          ...
                          null !== h &&
                              ...
                              c - t < r && ((l = -t), (h = f(h, l, d + 1)), +h.toFixed(x) > +l.toFixed(x) && (k = c > r ? -(c - r) : -(t - (h - l))))))
                        : 0 < c &&
                          ...
                          null !== h &&
                              ...
                              c - t < r && ((l = t), (h = f(h, l, d + 1)), +h.toFixed(x) < +l.toFixed(x) && (k = c > r ? c - r : t - (l - h)))));
                    k &&
                        ((d = p.indexLabelTextBlock.y + k),
                        (c = 0),
                        (c = "right" === p.hemisphere ? A.x + Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2)) : A.x - Math.sqrt(Math.pow(w, 2) - Math.pow(d - A.y, 2))),
                        p.midAngle > Math.PI / 2 - u && p.midAngle < Math.PI / 2 + u
                            ? ((l = (a - 1 + g.length) % g.length),
                              (l = g[l]),
                              (a = g[(a + 1 + g.length) % g.length]),
                              "left" === p.hemisphere && "right" === l.hemisphere && c > l.indexLabelTextBlock.x
                            ...
                            : p.midAngle > (3 * Math.PI) / 2 - u &&
                              ...
                              (l = g[l]),
                              (a = g[(a + 1 + g.length) % g.length]),
                              "right" === p.hemisphere && "left" === l.hemisphere && c < l.indexLabelTextBlock.x
                                  ? (c = l.indexLabelTextBlock.x + 15)
                        ...
                        (p.indexLabelAngle = Math.atan2(p.indexLabelTextBlock.y - A.y, p.indexLabelTextBlock.x - A.x)));
                }
                return k;
            }
            function l() {
                ...
                for (var c = (a = 0), d = 0, l = !0, c = 0; 10 > c && (1 > c || 0 < d); c++) {
                    if (k.radius || (!k.radius && "undefined" !== typeof k.innerRadius && null !== k.innerRadius && z - d <= y)) l = !1;
                    l && (z -= d);
                    d = 0;
                    if ("inside" !== k.indexLabelPlacement) {
                        ...
                        for (var t, u, a = 0; a < m.length; a++) {
                            ...
                            if (null !== s) {
                                ...
                                var C = 0,
                                    C = b(t, u) - r;
                                if (0 > C) {
                                    for (var D = (u = 0), F = 0; F < m.length; F++) F !== a && g[F].hemisphere === h.hemisphere && (g[F].indexLabelTextBlock.y < h.indexLabelTextBlock.y ? u++ : D++);
                                    u = (C / (u + D || 1)) * D;
                                    var D = -1 * (C - u),
                                        J = (F = 0);
                                    "right" === h.hemisphere
                        ...
                        for (a = 0; a < m.length; a++)
                            (h = g[a]), (w = "pie" === k.type ? 0.7 * z : 0.8 * z), (s = A.x + w * Math.cos(h.midAngle)), (u = A.y + w * Math.sin(h.midAngle)), (h.indexLabelTextBlock.x = s), (h.indexLabelTextBlock.y = u);
                    for (a = 0; a < m.length; a++)
                        if (((h = g[a]), (s = h.indexLabelTextBlock.measureText()), 0 !== s.height && 0 !== s.width))
                            (s = s = 0),
                                "right" === h.hemisphere ? ((s = q.x2 - (h.indexLabelTextBlock.x + h.indexLabelTextBlock.width + p)), (s *= -1)) : (s = q.x1 - (h.indexLabelTextBlock.x - h.indexLabelTextBlock.width - p)),
                                0 < s &&
                                    (!l &&
                                        h.indexLabelText &&
                                        ((u = "right" === h.hemisphere ? q.x2 - h.indexLabelTextBlock.x : h.indexLabelTextBlock.x - q.x1),
                                        0.3 * h.indexLabelTextBlock.maxWidth > u ? (h.indexLabelText = "") : (h.indexLabelTextBlock.maxWidth = 0.85 * u),
                                        0.3 * h.indexLabelTextBlock.maxWidth < u && (h.indexLabelTextBlock.x -= "right" === h.hemisphere ? 2 : -2)),
                                    Math.abs(h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - A.y) < z || Math.abs(h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 - A.y) < z) &&
                                    ((s /= Math.abs(Math.cos(h.indexLabelAngle))), 9 < s && (s *= 0.3), s > d && (d = s)),
                                (s = s = 0),
                                0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI
                                    ? ((s = q.y2 - (h.indexLabelTextBlock.y + h.indexLabelTextBlock.height / 2 + 5)), (s *= -1))
                                    : (s = q.y1 - (h.indexLabelTextBlock.y - h.indexLabelTextBlock.height / 2 - 5)),
                                0 < s &&
                                    (!l && h.indexLabelText && ((u = 0 < h.indexLabelAngle && h.indexLabelAngle < Math.PI ? -1 : 1), 0 === f(a, s * u) && f(a, 2 * u)),
                                    Math.abs(h.indexLabelTextBlock.x - A.x) < z && ((s /= Math.abs(Math.sin(h.indexLabelAngle))), 9 < s && (s *= 0.3), s > d && (d = s)));
                    ...
                    this._animator.animate(
                        ...
                        function (a) {
                            ...
                            for (var b = g[0].startAngle + 2 * Math.PI * a, c = 0; c < m.length; c++) {
                                ...
                                e > d && ga(n.plotArea.ctx, g[c].center, g[c].radius, l, k.type, d, e, k.fillOpacity, g[c].percentInnerRadius);
                                if (f) break;
                            }
                            h();
                            n.dispatchEvent("dataAnimationIterationEnd", { chart: n });
        ...
        n.prototype.renderFunnel = function (a) {
            ...
            function c() {
                ...
                if (0 === g) return -1;
                for (var l = (d[0] = 0), h = 0, m, p, b = b - a, l = !1, k = 0; k < x.length; k++)
                    (a = (Math.abs(x[k].y) * f) / g),
                        l
                            ? (m = 0 == Number(c.toFixed(3)) ? 0 : a / c)
                            : ((p = $ * $ * b * b - 4 * Math.abs($) * a),
                              0 > p
                                  ? ((p = c), (l = ((b + p) * (e - h)) / 2), (a -= l), (m = e - h), (h += e - h), (m += 0 == p ? 0 : a / p), (h += a / p), (l = !0))
                                  : ((m = (Math.abs($) * b - Math.sqrt(p)) / 2),
                                    (p = b - (2 * m) / Math.abs($)),
                                    (h += m),
                                    h > e && ((h -= m), (p = c), (l = ((b + p) * (e - h)) / 2), (a -= l), (m = e - h), (h += e - h), (m += a / p), (h += a / p), (l = !0)),
                                    (b = p))),
                        d.push(m);
                return d;
            }
            function b() {
                if (u && x) {
                    for (var a, b, c, d, e, f, k, l, h, m, p, q, t, n, r, B = [], v = [], A = { percent: null, total: null }, C = null, z = 0; z < x.length; z++)
                        (r = O[z]), (r = "undefined" !== typeof r.x5 ? (r.y2 + r.y4) / 2 : (r.y2 + r.y3) / 2), (r = g(r).x2 + 1), (B[z] = M - r - U);
                    r = 0.5 * U;
                ...
                if (e)
                    for (l = I.length - 1; 0 <= l; l--)
                        (a = O[l]),
                            ...
                            u.reversed
                                ? (I[l].textBlock.y + I[l].height > na + C && (I[l].textBlock.y = na + C - I[l].height), I[l].textBlock.y < sa - C && (I[l].textBlock.y = sa - C))
                                : (I[l].textBlock.y < na - C && (I[l].textBlock.y = na - C), I[l].textBlock.y + I[l].height > sa + C && (I[l].textBlock.y = sa + C - I[l].height));
            }
            function f() {
                var a, b, c, d;
            ...
            function l() {
                    ...
                    for (var k, h = 1; h < l; h++) {
                        ...
                        for (var t = I.length - 1; 0 <= t; t--)
                            !I[t].isDirty &&
                                ...
                                ((k = q(t)), !(k >= I.length - 1) && I[t].textBlock.y + I[t].height + da > I[k].textBlock.y && (I[t].textBlock.y = I[t].textBlock.y + I[t].height - e > e - I[t].textBlock.y ? e + 1 : e - I[t].height - 1));
                    }
                ...
                for (var d, e, f, g, l, k, m = 1, n = 0; n < 2 * m; n++) {
                    for (
                        ...
                        (e = +g.y.toFixed(6)),
                        !f.isDirty && l && e + d + da > +k.y.toFixed(6) && ((d = g.y + d + da - k.y), (e = a(r, -d)), e < d && (0 < e && (d -= e), (e = a(q(r), d)), e != d)));
                        r--
                    );
                    b();
                }
            ...
            function n(a, b, c) {
                ...
                if (0 === X.length) l = ga;
                    ...
                    for (var t = 0; t < O.length; t++) {
                        ...
                        l.push(ga[t] + d);
                        if (0 <= X.indexOf(t) || (t < O.length && 0 <= X.indexOf(t + 1))) d += e;
                    }
                }
                g = (function () {
            ...
            if (!(0 >= a.dataSeriesIndexes.length)) {
                ...
                if (0 != u.length && u.dataPoints && u.visible && 0 !== x.length) {
                    ...
                    if (-1 !== H) {
                        if (u.reversed) for (F.push(Z), G = H.length - 1; 0 < G; G--) (Z += H[G]), F.push(Z);
                        else for (G = 0; G < H.length; G++) (Z += H[G]), F.push(Z);
                        if (u.reversed) for (G = 0; G < H.length; G++) F[G] < xa ? (a.push(L), D.push(V), (ca = G)) : (a.push((F[G] - na + $ * W) / $), D.push((F[G] - na + ea * T) / ea));
                        else for (G = 0; G < H.length; G++) F[G] < xa ? (a.push((F[G] - na + $ * W) / $), D.push((F[G] - na + ea * T) / ea), (ca = G)) : (a.push(L), D.push(V));
                        for (G = 0; G < H.length - 1; G++)
                            (Z = u.reversed ? (x[x.length - 1 - G].color ? x[x.length - 1 - G].color : u._colorSet[(x.length - 1 - G) % u._colorSet.length]) : x[G].color ? x[G].color : u._colorSet[G % u._colorSet.length]),
                                G === ca
                                    ? O.push({ x1: a[G], y1: F[G], x2: D[G], y2: F[G], x3: V, y3: xa, x4: D[G + 1], y4: F[G + 1], x5: a[G + 1], y5: F[G + 1], x6: L, y6: xa, id: G, height: F[G + 1] - F[G], color: Z })
                                    : O.push({ x1: a[G], y1: F[G], x2: D[G], y2: F[G], x3: D[G + 1], y3: F[G + 1], x4: a[G + 1], y4: F[G + 1], id: G, height: F[G + 1] - F[G], color: Z });
                        var da = 2,
                            I = [],
                            ha = !1,
                            X = [],
                        ...
                        a = a = 0;
                        Ca(X);
                        for (G = 0; G < x.length; G++) x[G].exploded && ((H = !0), u.reversed ? X.push(x.length - 1 - G) : X.push(G));
                        ...
                        !y.animationEnabled && H ? n(y, -1, 0) : y.animationEnabled && !y.animatedRender && n(y, -1, 0);
                    ...
                    if ("pie" !== p.type && "doughnut" !== p.type && "funnel" !== p.type && "pyramid" !== p.type) {
                        ...
                        for (var x = 0; x < p.dataPoints.length; x++) {
                            var A = p.dataPoints[x],
                                q = A.legendMarkerType ? A.legendMarkerType : p.legendMarkerType ? p.legendMarkerType : H.getDefaultLegendMarker(p.type),
                                g = A.legendText
                                    ? A.legendText
                                    : p.legendText
                                    ? p.legendText
                                    : this.itemTextFormatter
                                    ? this.itemTextFormatter({ chart: this.chart, legend: this.options, dataSeries: p, dataPoint: A })
                                    : A.name
                                    ? A.name
                                    : "DataPoint: " + (x + 1),
                                r = A.legendMarkerColor ? A.legendMarkerColor : p.legendMarkerColor ? p.legendMarkerColor : A.color ? A.color : p.color ? p.color : p._colorSet[x % p._colorSet.length],
                                w = 0.75 * this.lineHeight,
                                v = A.legendMarkerBorderColor ? A.legendMarkerBorderColor : p.legendMarkerBorderColor ? p.legendMarkerBorderColor : A.markerBorderColor ? A.markerBorderColor : p.markerBorderColor,
                                ...
                                q = { markerType: q, markerColor: r, text: g, textBlock: null, chartType: p.type, markerSize: w, dataSeriesIndex: m, dataPointIndex: x, markerBorderColor: v, markerBorderThickness: u };
                            (A.showInLegend || (p.showInLegend && !1 !== A.showInLegend)) && n.push(q);
                        }
            }
                    ...
                    if (!(0 >= l || "undefined" === typeof l || 0 >= v || "undefined" === typeof v)) {
                        if ("horizontal" === this.orientation) {
                            ...
                            if (
                                !p ||
                                p.width +
                                    Math.round(q.textBlock.width + w + h + (0 === p.width ? 0 : this.horizontalSpacing) + ("line" === q.chartType || "spline" === q.chartType || "stepLine" === q.chartType ? 2 * 0.1 * this.lineHeight : 0)) >
                                    f
                            )
                        ...
                        switch (this.type) {
                            ...
                            case "doughnut":
                                ...
                                r < q.radius &&
                                    ...
                                    r > s && r < w && (b.push({ dataPoint: g, dataPointIndex: f, dataSeries: this, distance: 0 }), (h = !0)));
                                break;
                            case "funnel":
                            case "pyramid":
                                r = q.funnelSection;
                        ...
                        for (c = 0; c < this._labels.length; c++)
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                for (var v, g = a.text.split(" "), b = 0; b < g.length; b++)
                                    (m = g[b]), (this.ctx.font = a.fontStyle + " " + a.fontWeight + " " + a.fontSize + "px " + a.fontFamily), (m = this.ctx.measureText(m)), m.width > q && ((v = c), (q = m.width));
                            }
                        c = 0;
                            ...
                            if (!this._labels[c].breaksLabelType) {
                                ...
                                if (s(this.options.labelAngle) && isNaN(this.options.labelAngle) && 0 !== this.options.labelAngle)
                                    if (
                                        ...
                                        (m = (k - (n + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(-25))) / Math.sin((Math.PI / 180) * Math.abs(-25))),
                                    ...
                                    (m = 0 != this.labelAngle ? (k - (n + a.fontSize / 2) * Math.cos((Math.PI / 180) * Math.abs(this.labelAngle))) / Math.sin((Math.PI / 180) * Math.abs(this.labelAngle)) : f),
        ...
        E.setLayout = function (a, d, c, b, e, f) {
            ...
            for (g = 0; g < q.length; g++)
                if (q[g] && q[g].scaleBreaks && q[g].scaleBreaks._appliedBreaks.length)
                    for (var r = q[g].scaleBreaks._appliedBreaks, w = 0; w < r.length && !(r[w].startValue > q[g].viewportMaximum); w++)
                        r[w].endValue < q[g].viewportMinimum || (s(q[g].scaleBreaks.firstBreakIndex) && (q[g].scaleBreaks.firstBreakIndex = w), r[w].startValue >= q[g].viewPortMinimum && (q[g].scaleBreaks.lastBreakIndex = w));
            for (var v = (w = 0), u = 0, x = 0, A = 0, y = 0, D = 0, z, E, F = (h = 0), H, J, K, r = (H = J = K = !1), g = 0; g < q.length; g++)
                q[g] &&
                    q[g].title &&
            ...
            if ("normal" === e) {
                for (var x = [], A = [], y = [], D = [], M = [], N = [], P = [], R = []; 4 > w; ) {
                    var G = 0,
                        ...
                        O = 0,
                        $ = 0;
                    if (c && 0 < c.length) for (y = [], g = O = 0; g < c.length; g++) y.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateWidth() : 0)), (O += y[g]), (L += c[g] && !m.isNavigator ? c[g].margin : 0);
                    ...
                    if (d && 0 < d.length)
                        for (A = [], g = V = 0; g < d.length; g++)
                            d[g] && (d[g].lineCoordinates = {}),
                                ...
                                A.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateHeight() : 0)),
                                (V += A[g]),
                        ...
                        for (g = 0; g < a.length; g++)
                            a[g] &&
                                ...
                                !a[g] ||
                                    ...
                                    ((h = 0),
                                    0 < a[g].labelAngle
                                        ? E + u > n && (h += 0 < a[g].labelAngle ? E + u - n - $ : 0)
                                        : 0 > a[g].labelAngle
                                        ? z - v < l && z - v < a[g].viewportMinimum && (F = l - (L + a[g].tickLength + y + z - v + a[g].labelFontSize / 2))
                                        : 0 === a[g].labelAngle && (E + u > n && (h = E + u / 2 - n - $), z - v < l && z - v < a[g].viewportMinimum && (F = l - L - a[g].tickLength - y - z + v / 2)),
                                    a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 < a[g].labelAngle && 0 < h
                                        ...
                                        ? (l += F)
                                        : a[g].viewportMaximum === a[g].maximum && a[g].viewportMinimum === a[g].minimum && 0 === a[g].labelAngle && (0 < F && (l += F), 0 < h && (n -= h))),
                                ...
                                (a[g].bounds = { x1: l, y1: h, x2: n, y2: k - (T + e - x[g] - G), width: n - l, height: k - h })),
                                (G += x[g] + a[g].margin);
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++)
                            (d[g].lineCoordinates.x1 = Math.round(f.x1 + O + L)),
                                (d[g].lineCoordinates.x2 = Math.round(f.x2 - $ - Z > m.width - p ? m.width - p : f.x2 - $ - Z)),
                                (d[g].lineCoordinates.width = Math.abs(n - l)),
                                d[g]._labels &&
                                ...
                                "inside" === d[g].labelPlacement && 0 < g && (d[g].lineCoordinates.y1 = d[g - 1].bounds.y1 - A[g] + (d[g]._titleTextBlock ? d[g]._titleTextBlock.height : 0)),
                                (d[g].bounds = { x1: l, y1: h + (V + W - A[g] - S), x2: n, y2: k, width: n - l, height: k - h }),
                                (S += A[g] + d[g].margin);
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (L = m.isNavigator ? 0 : 10),
                                c[g] &&
                                    ...
                                    (n = Math.round(a[0] ? a[0].lineCoordinates.x1 : d[0].lineCoordinates.x1)),
                                    (L = 0 < a.length ? 0 : c[g]._labels && 0 < c[g]._labels.length ? c[g]._labels[0].textBlock.height / 2 : p),
                                    (k = Math.round(f.y2 - T - e - L)),
                                    (c[g].lineCoordinates = { x1: l - U, y1: h, x2: n - U, y2: k, height: Math.abs(k - h) }),
                                    "inside" === c[g].labelPlacement &&
                                        0 < g &&
                                        ((c[g].lineCoordinates.x1 = c[g].lineCoordinates.x1 - (y[g] - (c[g]._titleTextBlock ? c[g]._titleTextBlock.height : 0)) + ("outside" === c[g].tickPlacement ? c[g].tickLength : 0)),
                                        (c[g].lineCoordinates.x2 = c[g].lineCoordinates.x1 + c[g].lineThickness / 2)),
                                    (c[g].bounds = { x1: l - (y[g] + U), y1: h, x2: n, y2: k, width: n - l, height: k - h }),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                (b[g].bounds = { x1: l, y1: h, x2: n + (D[g] + X), y2: k, width: n - l, height: k - h }),
                    ...
                    if (0 < w) {
                        if (a && 0 < a.length) for (g = 0; g < a.length; g++) r = M[w - 1][g] === M[w][g] ? !0 : !1;
                        else r = !0;
                        if (d && 0 < d.length) for (g = 0; g < d.length; g++) H = N[w - 1][g] === N[w][g] ? !0 : !1;
                        else H = !0;
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = P[w - 1][g] === P[w][g] ? !0 : !1;
                        else J = !0;
                        if (b && 0 < b.length) for (g = 0; g < b.length; g++) K = R[w - 1][g] === R[w][g] ? !0 : !1;
                        else K = !0;
                    }
                    if (r && H && J && K) break;
                    w++;
                ...
                for (N = []; 4 > w; ) {
                    ...
                    if (a && 0 < a.length) for (F = [], g = X = 0; g < a.length; g++) F.push(Math.ceil(a[g] ? a[g].createLabelsAndCalculateWidth() : 0)), (X += F[g]), (e += a[g] && !m.isNavigator ? a[g].margin : 0);
                    else F.push(Math.ceil(a[0] ? a[0].createLabelsAndCalculateWidth() : 0));
                    M.push(F);
                    if (d && 0 < d.length) for (v = [], g = T = 0; g < d.length; g++) v.push(Math.ceil(d[g] ? d[g].createLabelsAndCalculateWidth() : 0)), (T += v[g]), (W += d[g] ? d[g].margin : 0);
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            (c[g].lineCoordinates = {}),
                                ...
                                (n = Math.round(f.x2 - T - W > m.width - 10 ? m.width - 10 : f.x2 - T - W)),
                                c[g].labelAutoFit &&
                                    !s(x) &&
                                    (0 < !a.length && (l = 0 > c[g].labelAngle ? Math.max(l, x) : 0 === c[g].labelAngle ? Math.max(l, x / 2) : l),
                                    0 < !d.length && (n = 0 < c[g].labelAngle ? n - A / 2 : 0 === c[g].labelAngle ? n - A / 2 : n)),
                    ...
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            (b[g].lineCoordinates = {}),
                                (l = Math.round(f.x1 + X + e)),
                                (n = Math.round(f.x2 - T - W > b[g].chart.width - 10 ? b[g].chart.width - 10 : f.x2 - T - W)),
                                b[g] && b[g].labelAutoFit && !s(y) && (0 < !a.length && (l = 0 < b[g].labelAngle ? Math.max(l, y) : 0 === b[g].labelAngle ? Math.max(l, y / 2) : l), 0 < !d.length && (n -= D / 2)),
                    ...
                    if (c && 0 < c.length) for (p = [], g = U = 0; g < c.length; g++) p.push(Math.ceil(c[g] ? c[g].createLabelsAndCalculateHeight() : 0)), (U += p[g] + c[g].margin), (L += c[g].margin);
                    else p.push(Math.ceil(c[0] ? c[0].createLabelsAndCalculateHeight() : 0));
                    E.push(p);
                    if (b && 0 < b.length) for (z = [], g = S = 0; g < b.length; g++) z.push(Math.ceil(b[g] ? b[g].createLabelsAndCalculateHeight() : 0)), (S += z[g]), (Z += b[g].margin);
                    ...
                    if (c && 0 < c.length)
                        for (g = 0; g < c.length; g++)
                            0 < c[g]._labels.length &&
                                ...
                                (A = h.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(h.textBlock.angle)) + (h.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(h.textBlock.angle))));
                    if (b && 0 < b.length)
                        for (g = 0; g < b.length; g++)
                            b[g] &&
                                ...
                                (y = k.textBlock.width * Math.cos((Math.PI / 180) * Math.abs(k.textBlock.angle)) + (k.textBlock.height - h.textBlock.fontSize / 2) * Math.sin((Math.PI / 180) * Math.abs(k.textBlock.angle))),
                    ...
                    if (m.panEnabled) for (g = 0; g < c.length; g++) p[g] = s(m.sessionVariables.axisY.height) ? (m.sessionVariables.axisY.height = p[g]) : m.sessionVariables.axisY.height;
                    else for (g = 0; g < c.length; g++) m.sessionVariables.axisY.height = p[g];
                    if (c && 0 < c.length)
                        for (g = c.length - 1; 0 <= g; g--)
                            (h = Math.round(f.y2)),
                                ...
                                (c[g].bounds = { x1: l, y1: h - (p[g] + V + c[g].margin), x2: n, y2: k - (V + c[g].margin), width: n - l, height: p[g] }),
                                c[g].title && (c[g]._titleTextBlock.maxWidth = 0 < c[g].titleMaxWidth && c[g].titleMaxWidth < c[g].lineCoordinates.width ? c[g].titleMaxWidth : c[g].lineCoordinates.width),
                                (V += p[g] + c[g].margin);
                    if (b && 0 < b.length)
                        for (g = b.length - 1; 0 <= g; g--)
                            b[g] &&
                                ...
                                (b[g].bounds = { x1: l, y1: h + (b[g].margin + G), x2: n, y2: k, width: n - l, height: S }),
                                b[g].title && (b[g]._titleTextBlock.maxWidth = 0 < b[g].titleMaxWidth && b[g].titleMaxWidth < b[g].lineCoordinates.width ? b[g].titleMaxWidth : b[g].lineCoordinates.width),
                                (G += z[g] + b[g].margin));
                    if (a && 0 < a.length)
                        for (g = 0; g < a.length; g++) {
                            ...
                            k =
                                c && 0 < c.length
                                    ? Math.round(c[0] ? c[0].lineCoordinates.y1 : f.y2 - U > m.height - Math.max(L, 10) ? m.height - Math.max(L, 10) : f.y2 - U)
                                    : f.y2 > m.height - Math.max(L, 10)
                                    ? m.height - Math.max(L, 10)
                                    : f.y2;
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++)
                                    c[L] && c[L].labelAutoFit && ((n = 0 > c[L].labelAngle ? Math.max(n, x) : 0 === c[L].labelAngle ? Math.max(n, x / 2) : n), (l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - X : l));
                            if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && ((n = b[L].lineCoordinates.x1), (l = n - X));
                            ...
                            a[g].bounds = { x1: n - (F[g] + P), y1: h, x2: n, y2: k, width: n - l, height: k - h };
                    ...
                    if (d && 0 < d.length)
                        for (g = 0; g < d.length; g++) {
                            ...
                            if (c && 0 < c.length)
                                for (L = 0; L < c.length; L++)
                                    c[L] && c[L].labelAutoFit && ((n = 0 > c[L].labelAngle ? Math.max(n, x) : 0 === c[L].labelAngle ? Math.max(n, x / 2) : n), (l = 0 > c[L].labelAngle || 0 === c[L].labelAngle ? n - T : l));
                            if (b && 0 < b.length) for (L = 0; L < b.length; L++) b[L] && b[L].labelAutoFit && ((n = b[L].lineCoordinates.x2), (l = n - T));
                    ...
                    if (0 < w) {
                        ...
                        if (c && 0 < c.length) for (g = 0; g < c.length; g++) J = E[w - 1][g] === E[w][g] ? !0 : !1;
                        else J = !0;
                    ...
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], e = 0 !== this.labelAngle && 360 !== this.labelAngle ? 1 : 1.2, l, h = this.viewportMaximum, n = this.lineCoordinates.width / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            ...
                            p.position > this.viewportMaximum ||
                                !(k === this._labels.length - 1 || l < (Math.log(h / p.position) * n) / e) ||
                ...
                if ("left" === this._position || "right" === this._position)
                    if (this.logarithmic && !this.equidistantInterval && this.labelAutoFit) {
                        for (var c = [], m, h = this.viewportMaximum, n = this.lineCoordinates.height / Math.log(this.range), k = this._labels.length - 1; 0 <= k; k--) {
                            ...
                            if (p.position < this.viewportMinimum) break;
                            p.position > this.viewportMaximum ||
                                !(k === this._labels.length - 1 || m < Math.log(h / p.position) * n) ||
                                (c.push(p), (h = p.position), (m = p.textBlock.height * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))));
                        }
                        this._labels = c;
                    } else {
                        for (k = 0; k < this._labels.length; k++)
                            (p = this._labels[k]),
                                p.position < this.viewportMinimum || ((m = p.textBlock.height * Math.abs(Math.cos((Math.PI / 180) * this.labelAngle)) + p.textBlock.width * Math.abs(Math.sin((Math.PI / 180) * this.labelAngle))), (b += m));
                ...
                if ("axisX" === this.type && c) {
                    this.intervalType ||
                        (b / 1 <= a
                            ...
                            : ((this.interval = b / (1 * R.yearDuration) <= a ? 1 : b / (2 * R.yearDuration) <= a ? 2 : b / (4 * R.yearDuration) <= a ? 4 : Math.floor(E.getNiceNumber(b / (a - 1), !0) / R.yearDuration)),
                ...
                if ("bottom" === this.scaleBreaks.parent._position || "top" === this.scaleBreaks.parent._position)
                    if (
                        ...
                        "top" === this.scaleBreaks.parent._position
                            ? ((e = this.chart.plotArea.y1), (n = (this.chart.plotArea.y2 + p / 2 + 0.5) << 0))
                            : ((e = this.chart.plotArea.y2), (n = (this.chart.plotArea.y1 - p / 2 + 0.5) << 0), (a *= -1)),
                    ...
                    if (
                        ...
                        "left" === this.scaleBreaks.parent._position
                            ? ((b = this.chart.plotArea.x1), (h = (this.chart.plotArea.x2 + p / 2 + 0.5) << 0))
                            : ((b = this.chart.plotArea.x2), (h = (this.chart.plotArea.x1 - p / 2 + 0.5) << 0), (a *= -1)),
        ...
        M.prototype.render = function () {
            ...
            if (0 < d) {
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    (e = f = 1 === this.ctx.lineWidth % 2 ? (a.x << 0) + 0.5 : a.x << 0), (h = this.chart.plotArea.y1), (n = this.chart.plotArea.y2), (this.bounds = { x1: e - d / 2, y1: h, x2: f + d / 2, y2: n });
                else if ("left" === this.parent._position || "right" === this.parent._position)
                    (h = n = 1 === this.ctx.lineWidth % 2 ? (a.y << 0) + 0.5 : a.y << 0), (e = this.chart.plotArea.x1), (f = this.chart.plotArea.x2), (this.bounds = { x1: e, y1: h - d / 2, x2: f, y2: n + d / 2 });
                this.ctx.moveTo(e, h);
                this.ctx.lineTo(f, n);
                this.ctx.stroke();
        ...
        Z.prototype.render = function (a, d, c) {
            ...
            if (this.snapToDataPoint) {
                ...
                if ("xySwapped" === this.chart.plotInfo.axisPlacement) {
                    ...
                    if ("bottom" === this.parent._position || "top" === this.parent._position) {
                        ...
                        if ("rangeBar" === this.parent.dataSeries[y].type || "error" === this.parent.dataSeries[y].type) {
                            ...
                            for (r = u = 0; r < x.dataPoint.y.length; r++) (u = Math.abs(a - this.parent.convertValueToPixel(x.dataPoint.y[r]))), u < v && ((v = u), (b = r));
                            n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y[b]) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y[b]) << 0;
                            this.value = x.dataPoint.y[b];
                            k.text = this.labelFormatter
                                ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.y[b] })
                            ...
                            v = Math.abs(a - this.parent.convertValueToPixel(m[0].dataPoint.y));
                            A = u = 0;
                            for (r = y; 0 <= r; r--) (A += m[r].dataPoint.y), (u = Math.abs(a - this.parent.convertValueToPixel(A))), u < v && ((v = u), (b = r));
                            n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(A) << 0) + 0.5 : this.parent.convertValueToPixel(A) << 0;
                            this.value = A;
                            k.text = this.labelFormatter
                            ...
                            (n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y) << 0),
                        ...
                        f = h = w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.x) << 0;
                        ...
                        if (C) {
                            ...
                            "dateTime" === this.parent.valueType
                                ? (k.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x })
                                      : s(this.options.label)
                                      ? Aa(x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                                      : this.label)
                                : "number" === this.parent.valueType &&
                                  (k.text = this.labelFormatter
                                      ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.x })
                                      : s(this.options.label)
                                      ? ea(x.dataPoint.x, this.valueFormatString, this.chart._cultureInfo)
                                      : this.label);
                    ...
                    x = m[0];
                    b = e = n = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.x) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.x) << 0;
                    f = this.chart.plotArea.y1;
                    h = this.chart.plotArea.y2;
                    this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h };
                    C = !1;
                    ...
                    if (
                        ...
                        for (r = u = 0; r < x.dataPoint.y.length; r++) (u = Math.abs(d - this.parent.convertValueToPixel(x.dataPoint.y[r]))), u < v && ((v = u), (b = r));
                        w = 1 === q.lineWidth % 2 ? (this.parent.convertValueToPixel(x.dataPoint.y[b]) << 0) + 0.5 : this.parent.convertValueToPixel(x.dataPoint.y[b]) << 0;
                        k.text = this.labelFormatter
                            ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataPoint.y[b] })
                            : s(this.options.label)
                            ? ea(c ? c : x.dataPoint.y[b], this.valueFormatString, this.chart._cultureInfo)
                        ...
                        A = u = 0;
                        for (r = y; 0 <= r; r--) (A += m[r].dataPoint.y), (u = Math.abs(d - this.parent.convertValueToPixel(A))), u < v && ((v = u), (b = r));
                        ...
                        "waterfall" === this.parent.dataSeries[y].type
                            ? ((w =
                              ...
                              (k.text = this.labelFormatter
                                  ? this.labelFormatter({ chart: this.chart, axis: this.parent.options, crosshair: this.options, value: x.dataSeries.dataPointEOs[x.index].cumulativeSum })
                                  : s(this.options.label)
                ...
                if ("bottom" === this.parent._position || "top" === this.parent._position)
                    (b = e = n = 1 === q.lineWidth % 2 ? (a << 0) + 0.5 : a << 0), (f = this.chart.plotArea.y1), (h = this.chart.plotArea.y2), (this.bounds = { x1: b - p / 2, y1: f, x2: e + p / 2, y2: h });
                else if ("left" === this.parent._position || "right" === this.parent._position)
                        ...
                        if (this.chart.axisX)
                            for (var v = 0; v < this.chart.axisX.length; v++) {
                                for (var h = this.chart.axisX[v].convertPixelToValue({ y: d }), k = null, b = 0; b < this.chart.axisX[v].dataSeries.length; b++)
                                    (k = this.chart.axisX[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && ((k.dataSeries = this.chart.axisX[v].dataSeries[b]), null !== k.dataPoint.y && n.push(k));
                                k = null;
                            }
                        if (this.chart.axisX2)
                            for (v = 0; v < this.chart.axisX2.length; v++) {
                                ...
                                for (b = 0; b < this.chart.axisX2[v].dataSeries.length; b++)
                                    (k = this.chart.axisX2[v].dataSeries[b].getDataPointAtX(h, c)) && 0 <= k.index && ((k.dataSeries = this.chart.axisX2[v].dataSeries[b]), null !== k.dataPoint.y && n.push(k));
                                k = null;
                            }
                    } else {
                        n = [];
                        ...
                        "rangeSplineArea" === b.type
                            ? ((f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx)),
                              ...
                              "undefined" !== typeof e.y2 &&
                                  ...
                                  V.drawMarkers([f])))
                            : "bubble" === b.type
                            ? ((f = b.getMarkerProperties(h, e.x1, e.y1, this.chart.overlaidCanvasCtx)), (f.size = e.size), (f.color = "white"), (f.borderColor = "white"), (d.globalAlpha = 0.3), V.drawMarkers([f]), (d.globalAlpha = 1))
                            : "column" === b.type ||
                              ...
                              "rangeColumn" === b.type ||
                              "waterfall" === b.type
                            ? $(d, e.x1, e.y1, e.x2, e.y2, "white", 0, null, !1, !1, !1, !1, 0.3)
                            : "pie" === b.type || "doughnut" === b.type
                            ? ga(d, e.center, e.radius, "white", b.type, e.startAngle, e.endAngle, 0.3, e.percentInnerRadius)
                            ...
                            ? ((d.globalAlpha = 1),
                              ...
                              d.stroke(),
                              $(d, e.x1, Math.min(e.y1, e.y4), e.x2, Math.max(e.y1, e.y4), "transparent", 2 * e.borderThickness, e.color, !1, !1, !1, !1),
                              (d.globalAlpha = 1))
                            : "ohlc" === b.type
                            ? ((d.globalAlpha = 1),
                              (d.strokeStyle = e.color),
        ...
        W.prototype.getToolTipInnerHTML = function (a) {
            a = a.entries;
            for (var d = null, c = null, b = null, e = 0, f = "", h = !0, n = 0; n < a.length; n++)
                ...
                for (var s = null, k = "", n = 0; n < a.length; n++)
                    (c = a[n].dataSeries),
                        ...
                        null === b.toolTipContent ||
                            ...
                            null === d && (d = ""),
                            !0 === this.reversed
                                ? ((d = this.chart.replaceKeywordsWithValue(f, b, c, e) + d), n < a.length - 1 && (d = "</br>" + d))
                                : ((d += this.chart.replaceKeywordsWithValue(f, b, c, e)), n < a.length - 1 && (d += "</br>")));
                null !== d && (d = k + d);
            } else {
                c = a[0].dataSeries;
                b = a[0].dataPoint;
                    ...
                    if (c) {
                        ...
                        "circle" === b
                            ? (c.moveTo(a, d),
                              ...
                              f && c.fill(),
                              n && (h ? c.stroke() : ((s = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = s))))
                            : "square" === b
                            ? (c.beginPath(), c.rect(a - e / 2, d - e / 2, e, e), f && c.fill(), n && (h ? c.stroke() : ((s = c.globalAlpha), (c.globalAlpha = 0.15), (c.strokeStyle = "black"), c.stroke(), (c.globalAlpha = s))))
                            : "triangle" === b
                            ? (c.beginPath(),
