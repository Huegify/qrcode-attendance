...
<div class="card">
    <div class="card-header">
        <h5 class="card-title">Wallet Ballance</h5>
        <h6 class="card-subtitle text-muted">The report contains all the wallet balance.</h6>
    </div>
    <div class="card-body">
        <!-- <div class="row">
            <div class="col-sm-4">
        ...
        <div class="row py-3 mb-3">
            <div class="col-sm-2">
                ...
                <select onchange="getSchoolCategory(this.value)" name="state_id" id="state_id" class="form-control">
...
<script>
    $("select").select2();
    var table, op = "Transaction.studentWallet";
